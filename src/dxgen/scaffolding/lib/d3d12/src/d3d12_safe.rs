...
impl D3D12CommandAllocator {
  ...
  pub unsafe fn get_private_data<T>(&self, guid: &GUID, data: Option<&mut T>) -> HResult<UINT> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12CommandAllocator)).GetPrivateData(guid, &mut lv1, data.map(|v|v as *const _ as *mut _).unwrap_or(ptr::null_mut())) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn set_private_data<T>(&self, guid: &GUID, data: &T) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12CommandAllocator)).SetPrivateData(guid, mem::size_of_val(data) as UINT, data as *const _ as *const _) };
    hr2ret(hr,hr)
  }
  ...
  pub fn set_name(&self, name: Cow<str>) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12CommandAllocator)).SetName(lv1.as_ptr() as LPCWSTR) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_device<T: HasIID>(&self) -> HResult<T> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12CommandAllocator)).GetDevice(T::iid(), &mut lv1 as *mut *mut _ as *mut *mut c_void) };
    hr2ret(hr,T::new(lv1))
  }
  ...
  pub fn reset(&self) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12CommandAllocator)).Reset() };
    hr2ret(hr,hr)
  }
...
impl D3D12CommandList {
  ...
  pub unsafe fn get_private_data<T>(&self, guid: &GUID, data: Option<&mut T>) -> HResult<UINT> {
    let mut lv1: UINT = data.as_ref().map(|v|mem::size_of_val(*v)).unwrap_or(0) as UINT;
    let hr=unsafe { (*(self.0 as *mut ID3D12CommandList)).GetPrivateData(guid, &mut lv1, data.map(|v|v as *const _ as *mut _).unwrap_or(ptr::null_mut())) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn set_private_data<T>(&self, guid: &GUID, data: &T) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12CommandList)).SetPrivateData(guid, mem::size_of_val(data) as UINT, data as *const _ as *const _) };
    hr2ret(hr,hr)
  }
  ...
  pub fn set_name(&self, name: Cow<str>) -> HResult<HRESULT> {
    let lv1: Vec<u16> = str_to_vec_u16(name);
    let hr=unsafe { (*(self.0 as *mut ID3D12CommandList)).SetName(lv1.as_ptr() as LPCWSTR) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_device<T: HasIID>(&self) -> HResult<T> {
    let mut lv1: *mut IUnknown = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut ID3D12CommandList)).GetDevice(T::iid(), &mut lv1 as *mut *mut _ as *mut *mut c_void) };
    hr2ret(hr,T::new(lv1))
  }
  ...
  pub fn get_type(&self) -> D3D12_COMMAND_LIST_TYPE {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12CommandList)).GetType() };
    hr
  }
...
impl D3D12CommandQueue {
  ...
  pub unsafe fn get_private_data<T>(&self, guid: &GUID, data: Option<&mut T>) -> HResult<UINT> {
    let mut lv1: UINT = data.as_ref().map(|v|mem::size_of_val(*v)).unwrap_or(0) as UINT;
    let hr=unsafe { (*(self.0 as *mut ID3D12CommandQueue)).GetPrivateData(guid, &mut lv1, data.map(|v|v as *const _ as *mut _).unwrap_or(ptr::null_mut())) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn set_private_data<T>(&self, guid: &GUID, data: &T) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12CommandQueue)).SetPrivateData(guid, mem::size_of_val(data) as UINT, data as *const _ as *const _) };
    hr2ret(hr,hr)
  }
  ...
  pub fn set_name(&self, name: Cow<str>) -> HResult<HRESULT> {
    let lv1: Vec<u16> = str_to_vec_u16(name);
    let hr=unsafe { (*(self.0 as *mut ID3D12CommandQueue)).SetName(lv1.as_ptr() as LPCWSTR) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_device<T: HasIID>(&self) -> HResult<T> {
    let mut lv1: *mut IUnknown = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut ID3D12CommandQueue)).GetDevice(T::iid(), &mut lv1 as *mut *mut _ as *mut *mut c_void) };
    hr2ret(hr,T::new(lv1))
  }
  ...
  pub fn copy_tile_mappings<T: HasIID, T1: HasIID>(&self, dst_resource: &T, dst_region_start_coordinate: &D3D12_TILED_RESOURCE_COORDINATE, src_resource: &T1, src_region_start_coordinate: &D3D12_TILED_RESOURCE_COORDINATE, region_size: &D3D12_TILE_REGION_SIZE, flags: D3D12_TILE_MAPPING_FLAGS) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12CommandQueue)).CopyTileMappings(dst_resource.iptr() as *mut _ as *mut _ , dst_region_start_coordinate, src_resource.iptr() as *mut _ as *mut _ , src_region_start_coordinate, region_size, flags) };
    ()
  }
  ...
  pub fn execute_command_lists<T: HasIID>(&self, command_lists: &[&T]) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12CommandQueue)).ExecuteCommandLists( same_length(&[Some(command_lists.len())]).expect("Arrays must have equal sizes") as UINT, lv1.as_mut_ptr() as *mut *mut _ as *mut *mut _) };
    ()
  }
  ...
  pub fn signal<T: HasIID>(&self, fence: &T, value: UINT64) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12CommandQueue)).Signal(fence.iptr() as *mut _ as *mut _ , value) };
    hr2ret(hr,hr)
  }
  ...
  pub fn wait<T: HasIID>(&self, fence: &T, value: UINT64) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12CommandQueue)).Wait(fence.iptr() as *mut _ as *mut _ , value) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_timestamp_frequency(&self) -> HResult<UINT64> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12CommandQueue)).GetTimestampFrequency(&mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn get_clock_calibration(&self) -> HResult<GPUCPUTimestamp> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12CommandQueue)).GetClockCalibration(&mut (lv1.gpu_timestamp) as *mut _ as *mut _, &mut (lv1.cpu_timestamp) as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn get_desc(&self) -> D3D12_COMMAND_QUEUE_DESC {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12CommandQueue)).GetDesc(&mut lv1 as *mut _ as *mut _) };
    lv1
  }
...
impl D3D12CommandSignature {
  ...
  pub unsafe fn get_private_data<T>(&self, guid: &GUID, data: Option<&mut T>) -> HResult<UINT> {
    let mut lv1: UINT = data.as_ref().map(|v|mem::size_of_val(*v)).unwrap_or(0) as UINT;
    let hr=unsafe { (*(self.0 as *mut ID3D12CommandSignature)).GetPrivateData(guid, &mut lv1, data.map(|v|v as *const _ as *mut _).unwrap_or(ptr::null_mut())) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn set_private_data<T>(&self, guid: &GUID, data: &T) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12CommandSignature)).SetPrivateData(guid, mem::size_of_val(data) as UINT, data as *const _ as *const _) };
    hr2ret(hr,hr)
  }
  ...
  pub fn set_name(&self, name: Cow<str>) -> HResult<HRESULT> {
    let lv1: Vec<u16> = str_to_vec_u16(name);
    let hr=unsafe { (*(self.0 as *mut ID3D12CommandSignature)).SetName(lv1.as_ptr() as LPCWSTR) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_device<T: HasIID>(&self) -> HResult<T> {
    let mut lv1: *mut IUnknown = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut ID3D12CommandSignature)).GetDevice(T::iid(), &mut lv1 as *mut *mut _ as *mut *mut c_void) };
    hr2ret(hr,T::new(lv1))
  }
...
impl D3D12DescriptorHeap {
  ...
  pub unsafe fn get_private_data<T>(&self, guid: &GUID, data: Option<&mut T>) -> HResult<UINT> {
    let mut lv1: UINT = data.as_ref().map(|v|mem::size_of_val(*v)).unwrap_or(0) as UINT;
    let hr=unsafe { (*(self.0 as *mut ID3D12DescriptorHeap)).GetPrivateData(guid, &mut lv1, data.map(|v|v as *const _ as *mut _).unwrap_or(ptr::null_mut())) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn set_private_data<T>(&self, guid: &GUID, data: &T) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12DescriptorHeap)).SetPrivateData(guid, mem::size_of_val(data) as UINT, data as *const _ as *const _) };
    hr2ret(hr,hr)
  }
  ...
  pub fn set_name(&self, name: Cow<str>) -> HResult<HRESULT> {
    let lv1: Vec<u16> = str_to_vec_u16(name);
    let hr=unsafe { (*(self.0 as *mut ID3D12DescriptorHeap)).SetName(lv1.as_ptr() as LPCWSTR) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_device<T: HasIID>(&self) -> HResult<T> {
    let mut lv1: *mut IUnknown = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut ID3D12DescriptorHeap)).GetDevice(T::iid(), &mut lv1 as *mut *mut _ as *mut *mut c_void) };
    hr2ret(hr,T::new(lv1))
  }
  ...
  pub fn get_desc(&self) -> D3D12_DESCRIPTOR_HEAP_DESC {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12DescriptorHeap)).GetDesc(&mut lv1 as *mut _ as *mut _) };
    lv1
  }
  ...
  pub fn get_cpu_descriptor_handle_for_heap_start(&self) -> D3D12_CPU_DESCRIPTOR_HANDLE {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12DescriptorHeap)).GetCPUDescriptorHandleForHeapStart(&mut lv1 as *mut _ as *mut _) };
    lv1
  }
  ...
  pub fn get_gpu_descriptor_handle_for_heap_start(&self) -> D3D12_GPU_DESCRIPTOR_HANDLE {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12DescriptorHeap)).GetGPUDescriptorHandleForHeapStart(&mut lv1 as *mut _ as *mut _) };
    lv1
  }
...
impl D3D12DeviceChild {
  ...
  pub unsafe fn get_private_data<T>(&self, guid: &GUID, data: Option<&mut T>) -> HResult<UINT> {
    let mut lv1: UINT = data.as_ref().map(|v|mem::size_of_val(*v)).unwrap_or(0) as UINT;
    let hr=unsafe { (*(self.0 as *mut ID3D12DeviceChild)).GetPrivateData(guid, &mut lv1, data.map(|v|v as *const _ as *mut _).unwrap_or(ptr::null_mut())) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn set_private_data<T>(&self, guid: &GUID, data: &T) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12DeviceChild)).SetPrivateData(guid, mem::size_of_val(data) as UINT, data as *const _ as *const _) };
    hr2ret(hr,hr)
  }
  ...
  pub fn set_name(&self, name: Cow<str>) -> HResult<HRESULT> {
    let lv1: Vec<u16> = str_to_vec_u16(name);
    let hr=unsafe { (*(self.0 as *mut ID3D12DeviceChild)).SetName(lv1.as_ptr() as LPCWSTR) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_device<T: HasIID>(&self) -> HResult<T> {
    let mut lv1: *mut IUnknown = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut ID3D12DeviceChild)).GetDevice(T::iid(), &mut lv1 as *mut *mut _ as *mut *mut c_void) };
    hr2ret(hr,T::new(lv1))
  }
...
impl D3D12Device {
  ...
  pub unsafe fn get_private_data<T>(&self, guid: &GUID, data: Option<&mut T>) -> HResult<UINT> {
    let mut lv1: UINT = data.as_ref().map(|v|mem::size_of_val(*v)).unwrap_or(0) as UINT;
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).GetPrivateData(guid, &mut lv1, data.map(|v|v as *const _ as *mut _).unwrap_or(ptr::null_mut())) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn set_private_data<T>(&self, guid: &GUID, data: &T) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).SetPrivateData(guid, mem::size_of_val(data) as UINT, data as *const _ as *const _) };
    hr2ret(hr,hr)
  }
  ...
  pub fn set_name(&self, name: Cow<str>) -> HResult<HRESULT> {
    let lv1: Vec<u16> = str_to_vec_u16(name);
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).SetName(lv1.as_ptr() as LPCWSTR) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_node_count(&self) -> UINT {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).GetNodeCount() };
    hr
  }
  ...
  pub fn create_command_queue(&self, desc: &D3D12_COMMAND_QUEUE_DESC) -> HResult<D3D12CommandQueue> {
    let mut lv1: *mut IUnknown = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).CreateCommandQueue(desc, D3D12CommandQueue::iid(), &mut lv1 as *mut *mut _ as *mut *mut c_void) };
  ...
  pub fn create_command_allocator(&self, type_: D3D12_COMMAND_LIST_TYPE) -> HResult<D3D12CommandAllocator> {
    let mut lv1: *mut IUnknown = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).CreateCommandAllocator(type_, D3D12CommandAllocator::iid(), &mut lv1 as *mut *mut _ as *mut *mut c_void) };
  ...
  pub fn create_graphics_pipeline_state(&self, desc: &D3D12_GRAPHICS_PIPELINE_STATE_DESC) -> HResult<D3D12PipelineState> {
    let mut lv1: *mut IUnknown = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).CreateGraphicsPipelineState(desc, D3D12PipelineState::iid(), &mut lv1 as *mut *mut _ as *mut *mut c_void) };
  ...
  pub fn create_compute_pipeline_state(&self, desc: &D3D12_COMPUTE_PIPELINE_STATE_DESC) -> HResult<D3D12PipelineState> {
    let mut lv1: *mut IUnknown = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).CreateComputePipelineState(desc, D3D12PipelineState::iid(), &mut lv1 as *mut *mut _ as *mut *mut c_void) };
    hr2ret(hr,D3D12PipelineState::new(lv1))
  }
  ...
  pub fn create_command_list<T: HasIID, T1: HasIID>(&self, nodeMask: UINT, type_: D3D12_COMMAND_LIST_TYPE, command_allocator: &T, initial_state: Option<&D3D12PipelineState>) -> HResult<T1> {
    let mut lv1: *mut IUnknown = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).CreateCommandList(nodeMask, type_, command_allocator.iptr() as *mut _ as *mut _ , initial_state.map(|i|i.iptr()).unwrap_or(ptr::null_mut()) as *mut _ as *mut _, T1::iid(), &mut lv1 as *mut *mut _ as *mut *mut c_void) };
  ...
  pub fn check_feature_support_options(&self, feature_support_data: &mut D3D12_FEATURE_DATA_D3D12_OPTIONS) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).CheckFeatureSupport(D3D12_FEATURE_D3D12_OPTIONS, feature_support_data as *mut _ as *mut _, mem::size_of_val(feature_support_data) as UINT) };
    hr2ret(hr,hr)
  }
  ...
  pub fn check_feature_support_arch(&self, feature_support_data: &mut D3D12_FEATURE_DATA_ARCHITECTURE) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).CheckFeatureSupport(D3D12_FEATURE_ARCHITECTURE, feature_support_data as *mut _ as *mut _, mem::size_of_val(feature_support_data) as UINT) };
    hr2ret(hr,hr)
  }
  ...
  pub fn check_feature_support_feature_levels(&self, feature_support_data: &mut D3D12_FEATURE_DATA_FEATURE_LEVELS) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).CheckFeatureSupport(D3D12_FEATURE_FEATURE_LEVELS, feature_support_data as *mut _ as *mut _, mem::size_of_val(feature_support_data) as UINT) };
    hr2ret(hr,hr)
  }
  ...
  pub fn check_feature_support_format_support(&self, feature_support_data: &mut D3D12_FEATURE_DATA_FORMAT_SUPPORT) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).CheckFeatureSupport(D3D12_FEATURE_FORMAT_SUPPORT, feature_support_data as *mut _ as *mut _, mem::size_of_val(feature_support_data) as UINT) };
    hr2ret(hr,hr)
  }
  ...
  pub fn check_feature_support_multisample_quality_levels(&self, feature_support_data: &mut D3D12_FEATURE_DATA_MULTISAMPLE_QUALITY_LEVELS) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).CheckFeatureSupport(D3D12_FEATURE_MULTISAMPLE_QUALITY_LEVELS, feature_support_data as *mut _ as *mut _, mem::size_of_val(feature_support_data) as UINT) };
    hr2ret(hr,hr)
  }
  ...
  pub fn check_feature_support_format_info(&self, feature_support_data: &mut D3D12_FEATURE_DATA_FORMAT_INFO) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).CheckFeatureSupport(D3D12_FEATURE_FORMAT_INFO, feature_support_data as *mut _ as *mut _, mem::size_of_val(feature_support_data) as UINT) };
    hr2ret(hr,hr)
  }
  ...
  pub fn create_descriptor_heap(&self, descriptor_heap_desc: &D3D12_DESCRIPTOR_HEAP_DESC) -> HResult<D3D12DescriptorHeap> {
    let mut lv1: *mut IUnknown = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).CreateDescriptorHeap(descriptor_heap_desc, D3D12DescriptorHeap::iid(), &mut lv1 as *mut *mut _ as *mut *mut c_void) };
  ...
  pub fn get_descriptor_handle_increment_size(&self, descriptor_heap_type: D3D12_DESCRIPTOR_HEAP_TYPE) -> UINT {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).GetDescriptorHandleIncrementSize(descriptor_heap_type) };
    hr
  }
  ...
  pub fn create_root_signature<T>(&self, nodeMask: UINT, blob_with_root_signature: &[T]) -> HResult<D3D12RootSignature> {
    let mut lv1: *mut IUnknown = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).CreateRootSignature(nodeMask, blob_with_root_signature.as_ptr() as *const _, (mem::size_of_val(blob_with_root_signature)/1) as SIZE_T, D3D12RootSignature::iid(), &mut lv1 as *mut *mut _ as *mut *mut c_void) };
  ...
  pub fn create_constant_buffer_view(&self, desc: Option<&D3D12_CONSTANT_BUFFER_VIEW_DESC>, dest_descriptor: D3D12_CPU_DESCRIPTOR_HANDLE) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).CreateConstantBufferView(desc.as_ref().map(|p|*p as *const _ as *const _).unwrap_or(ptr::null()), dest_descriptor) };
    ()
  }
  ...
  pub fn create_shader_resource_view(&self, resource: Option<&D3D12Resource>, desc: Option<&D3D12_SHADER_RESOURCE_VIEW_DESC>, dest_descriptor: D3D12_CPU_DESCRIPTOR_HANDLE) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).CreateShaderResourceView(resource.map(|i|i.iptr()).unwrap_or(ptr::null_mut()) as *mut _ as *mut _, desc.as_ref().map(|p|*p as *const _ as *const _).unwrap_or(ptr::null()), dest_descriptor) };
    ()
  }
  ...
  pub fn create_unordered_access_view(&self, resource: Option<&mut ID3D12Resource>, counter_resource: Option<&mut ID3D12Resource>, desc: Option<&D3D12_UNORDERED_ACCESS_VIEW_DESC>, dest_descriptor: D3D12_CPU_DESCRIPTOR_HANDLE) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).CreateUnorderedAccessView(opt_as_mut_ptr(&resource), opt_as_mut_ptr(&counter_resource), desc.as_ref().map(|p|*p as *const _ as *const _).unwrap_or(ptr::null()), dest_descriptor) };
    ()
  }
  ...
  pub fn create_render_target_view(&self, resource: Option<&D3D12Resource>, desc: Option<&D3D12_RENDER_TARGET_VIEW_DESC>, dest_descriptor: D3D12_CPU_DESCRIPTOR_HANDLE) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).CreateRenderTargetView(resource.map(|i|i.iptr()).unwrap_or(ptr::null_mut()) as *mut _ as *mut _, desc.as_ref().map(|p|*p as *const _ as *const _).unwrap_or(ptr::null()), dest_descriptor) };
    ()
  }
  ...
  pub fn create_depth_stencil_view(&self, resource: Option<&D3D12Resource>, desc: Option<&D3D12_DEPTH_STENCIL_VIEW_DESC>, dest_descriptor: D3D12_CPU_DESCRIPTOR_HANDLE) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).CreateDepthStencilView(resource.map(|i|i.iptr()).unwrap_or(ptr::null_mut()) as *mut _ as *mut _, desc.as_ref().map(|p|*p as *const _ as *const _).unwrap_or(ptr::null()), dest_descriptor) };
    ()
  }
  ...
  pub fn create_sampler(&self, desc: &D3D12_SAMPLER_DESC, dest_descriptor: D3D12_CPU_DESCRIPTOR_HANDLE) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).CreateSampler(desc, dest_descriptor) };
    ()
  }
  ...
  pub fn copy_descriptors_simple(&self, num_descriptors: UINT, dest_descriptor_range_start: D3D12_CPU_DESCRIPTOR_HANDLE, src_descriptor_range_start: D3D12_CPU_DESCRIPTOR_HANDLE, descriptor_heaps_type: D3D12_DESCRIPTOR_HEAP_TYPE) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).CopyDescriptorsSimple(num_descriptors, dest_descriptor_range_start, src_descriptor_range_start, descriptor_heaps_type) };
    ()
  }
  ...
  pub fn get_resource_allocation_info(&self, visibleMask: UINT, resource_descs: &[D3D12_RESOURCE_DESC]) -> D3D12_RESOURCE_ALLOCATION_INFO {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).GetResourceAllocationInfo(visibleMask,  same_length(&[Some(resource_descs.len())]).expect("Arrays must have equal sizes") as UINT, slice_as_ptr(resource_descs), &mut lv1 as *mut _ as *mut _) };
    lv1
  }
  ...
  pub fn get_custom_heap_properties(&self, nodeMask: UINT, heapType: D3D12_HEAP_TYPE) -> D3D12_HEAP_PROPERTIES {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).GetCustomHeapProperties(nodeMask, heapType, &mut lv1 as *mut _ as *mut _) };
    lv1
  }
  ...
  pub fn create_committed_resource(&self, heap_properties: &D3D12_HEAP_PROPERTIES, heap_flags: D3D12_HEAP_FLAGS, resource_desc: &D3D12_RESOURCE_DESC, initial_resource_state: D3D12_RESOURCE_STATES, optimized_clear_value: Option<&D3D12_CLEAR_VALUE>) -> HResult<D3D12Resource> {
    let mut lv1: *mut IUnknown = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).CreateCommittedResource(heap_properties, heap_flags, resource_desc, initial_resource_state, optimized_clear_value.as_ref().map(|p|*p as *const _ as *const _).unwrap_or(ptr::null()), D3D12Resource::iid(), &mut lv1 as *mut *mut _ as *mut *mut c_void) };
  ...
  pub fn create_heap(&self, desc: &D3D12_HEAP_DESC) -> HResult<D3D12Heap> {
    let mut lv1: *mut IUnknown = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).CreateHeap(desc, D3D12Heap::iid(), &mut lv1 as *mut *mut _ as *mut *mut c_void) };
  ...
  pub fn create_placed_resource(&self, heap: &mut ID3D12Heap, heap_offset: UINT64, desc: &D3D12_RESOURCE_DESC, initial_state: D3D12_RESOURCE_STATES, optimized_clear_value: Option<&D3D12_CLEAR_VALUE>) -> HResult<D3D12Resource> {
    let mut lv1: *mut IUnknown = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).CreatePlacedResource(heap, heap_offset, desc, initial_state, optimized_clear_value.as_ref().map(|p|*p as *const _ as *const _).unwrap_or(ptr::null()), D3D12Resource::iid(), &mut lv1 as *mut *mut _ as *mut *mut c_void) };
    hr2ret(hr,D3D12Resource::new(lv1))
  }
  ...
  pub fn create_reserved_resource(&self, desc: &D3D12_RESOURCE_DESC, initial_state: D3D12_RESOURCE_STATES, optimized_clear_value: Option<&D3D12_CLEAR_VALUE>) -> HResult<D3D12Resource> {
    let mut lv1: *mut IUnknown = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).CreateReservedResource(desc, initial_state, optimized_clear_value.as_ref().map(|p|*p as *const _ as *const _).unwrap_or(ptr::null()), D3D12Resource::iid(), &mut lv1 as *mut *mut _ as *mut *mut c_void) };
    hr2ret(hr,D3D12Resource::new(lv1))
  }
  ...
  pub fn create_shared_handle(&self, object: &mut ID3D12DeviceChild, attributes: Option<&SECURITY_ATTRIBUTES>, access: DWORD, name: Cow<str>) -> HResult<HANDLE> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).CreateSharedHandle(object, attributes.as_ref().map(|p|*p as *const _ as *const _).unwrap_or(ptr::null()), access, lv1.as_ptr() as LPCWSTR, &mut lv2 as *mut _ as *mut _) };
    hr2ret(hr,lv2)
  }
  ...
  pub fn open_shared_handle<T: HasIID>(&self, n_t_handle: HANDLE) -> HResult<T> {
    let mut lv1: *mut IUnknown = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).OpenSharedHandle(n_t_handle, T::iid(), &mut lv1 as *mut *mut _ as *mut *mut c_void) };
    hr2ret(hr,T::new(lv1))
  }
  ...
  pub fn open_shared_handle_by_name(&self, name: Cow<str>, access: DWORD) -> HResult<HANDLE> {
    let lv1: Vec<u16> = str_to_vec_u16(name);
    let mut lv2: HANDLE = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).OpenSharedHandleByName(lv1.as_ptr() as LPCWSTR, access, &mut lv2 as *mut _ as *mut _) };
    hr2ret(hr,lv2)
  }
  ...
  pub fn make_resident<T: HasIID>(&self, objects: &[&T]) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).MakeResident( same_length(&[Some(objects.len())]).expect("Arrays must have equal sizes") as UINT, lv1.as_mut_ptr() as *mut *mut _ as *mut *mut _) };
    hr2ret(hr,hr)
  }
  ...
  pub fn evict<T: HasIID>(&self, objects: &[&T]) -> HResult<HRESULT> {
    let mut lv1: Vec<*mut IUnknown> = objects.iter().map(|o|o.iptr()).collect();
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).Evict( same_length(&[Some(objects.len())]).expect("Arrays must have equal sizes") as UINT, lv1.as_mut_ptr() as *mut *mut _ as *mut *mut _) };
    hr2ret(hr,hr)
  }
  ...
  pub fn create_fence(&self, initial_value: UINT64, flags: D3D12_FENCE_FLAGS) -> HResult<D3D12Fence> {
    let mut lv1: *mut IUnknown = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).CreateFence(initial_value, flags, D3D12Fence::iid(), &mut lv1 as *mut *mut _ as *mut *mut c_void) };
  ...
  pub fn get_device_removed_reason(&self) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).GetDeviceRemovedReason() };
    hr2ret(hr,hr)
  }
  ...
  pub fn create_query_heap(&self, desc: &D3D12_QUERY_HEAP_DESC) -> HResult<D3D12QueryHeap> {
    let mut lv1: *mut IUnknown = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).CreateQueryHeap(desc, D3D12QueryHeap::iid(), &mut lv1 as *mut *mut _ as *mut *mut c_void) };
  ...
  pub fn set_stable_power_state(&self, enable: BOOL) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).SetStablePowerState(enable) };
    hr2ret(hr,hr)
  }
  ...
  pub fn create_command_signature(&self, desc: &D3D12_COMMAND_SIGNATURE_DESC, root_signature: Option<&mut ID3D12RootSignature>) -> HResult<D3D12CommandSignature> {
    let mut lv1: *mut IUnknown = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).CreateCommandSignature(desc, opt_as_mut_ptr(&root_signature), D3D12CommandSignature::iid(), &mut lv1 as *mut *mut _ as *mut *mut c_void) };
  ...
  pub fn get_adapter_luid(&self) -> LUID {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12Device)).GetAdapterLuid(&mut lv1 as *mut _ as *mut _) };
    lv1
  }
...
impl D3D12Fence {
  ...
  pub unsafe fn get_private_data<T>(&self, guid: &GUID, data: Option<&mut T>) -> HResult<UINT> {
    let mut lv1: UINT = data.as_ref().map(|v|mem::size_of_val(*v)).unwrap_or(0) as UINT;
    let hr=unsafe { (*(self.0 as *mut ID3D12Fence)).GetPrivateData(guid, &mut lv1, data.map(|v|v as *const _ as *mut _).unwrap_or(ptr::null_mut())) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn set_private_data<T>(&self, guid: &GUID, data: &T) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12Fence)).SetPrivateData(guid, mem::size_of_val(data) as UINT, data as *const _ as *const _) };
    hr2ret(hr,hr)
  }
  ...
  pub fn set_name(&self, name: Cow<str>) -> HResult<HRESULT> {
    let lv1: Vec<u16> = str_to_vec_u16(name);
    let hr=unsafe { (*(self.0 as *mut ID3D12Fence)).SetName(lv1.as_ptr() as LPCWSTR) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_device<T: HasIID>(&self) -> HResult<T> {
    let mut lv1: *mut IUnknown = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut ID3D12Fence)).GetDevice(T::iid(), &mut lv1 as *mut *mut _ as *mut *mut c_void) };
    hr2ret(hr,T::new(lv1))
  }
  ...
  pub fn get_completed_value(&self) -> UINT64 {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12Fence)).GetCompletedValue() };
    hr
  }
  ...
  pub fn set_event_on_completion(&self, value: UINT64, hEvent: HANDLE) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12Fence)).SetEventOnCompletion(value, hEvent) };
    hr2ret(hr,hr)
  }
  ...
  pub fn signal(&self, value: UINT64) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12Fence)).Signal(value) };
    hr2ret(hr,hr)
  }
...
impl D3D12GraphicsCommandList {
  ...
  pub unsafe fn get_private_data<T>(&self, guid: &GUID, data: Option<&mut T>) -> HResult<UINT> {
    let mut lv1: UINT = data.as_ref().map(|v|mem::size_of_val(*v)).unwrap_or(0) as UINT;
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).GetPrivateData(guid, &mut lv1, data.map(|v|v as *const _ as *mut _).unwrap_or(ptr::null_mut())) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn set_private_data<T>(&self, guid: &GUID, data: &T) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).SetPrivateData(guid, mem::size_of_val(data) as UINT, data as *const _ as *const _) };
    hr2ret(hr,hr)
  }
  ...
  pub fn set_name(&self, name: Cow<str>) -> HResult<HRESULT> {
    let lv1: Vec<u16> = str_to_vec_u16(name);
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).SetName(lv1.as_ptr() as LPCWSTR) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_device<T: HasIID>(&self) -> HResult<T> {
    let mut lv1: *mut IUnknown = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).GetDevice(T::iid(), &mut lv1 as *mut *mut _ as *mut *mut c_void) };
    hr2ret(hr,T::new(lv1))
  }
  ...
  pub fn get_type(&self) -> D3D12_COMMAND_LIST_TYPE {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).GetType() };
    hr
  }
  ...
  pub fn close(&self) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).Close() };
    hr2ret(hr,hr)
  }
  ...
  pub fn reset<T: HasIID>(&self, allocator: &T, initial_state: Option<&D3D12PipelineState>) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).Reset(allocator.iptr() as *mut _ as *mut _ , initial_state.map(|i|i.iptr()).unwrap_or(ptr::null_mut()) as *mut _ as *mut _) };
    hr2ret(hr,hr)
  }
  ...
  pub fn clear_state(&self, pipeline_state: Option<&D3D12PipelineState>) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).ClearState(pipeline_state.map(|i|i.iptr()).unwrap_or(ptr::null_mut()) as *mut _ as *mut _) };
    ()
  }
  ...
  pub fn draw_instanced(&self, vertex_count_per_instance: UINT, instance_count: UINT, start_vertex_location: UINT, start_instance_location: UINT) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).DrawInstanced(vertex_count_per_instance, instance_count, start_vertex_location, start_instance_location) };
    ()
  }
  ...
  pub fn draw_indexed_instanced(&self, index_count_per_instance: UINT, instance_count: UINT, start_index_location: UINT, base_vertex_location: INT, start_instance_location: UINT) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).DrawIndexedInstanced(index_count_per_instance, instance_count, start_index_location, base_vertex_location, start_instance_location) };
    ()
  }
  ...
  pub fn dispatch(&self, thread_group_count_x: UINT, thread_group_count_y: UINT, thread_group_count_z: UINT) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).Dispatch(thread_group_count_x, thread_group_count_y, thread_group_count_z) };
    ()
  }
  ...
  pub fn copy_buffer_region<T: HasIID, T1: HasIID>(&self, dst_buffer: &T, dst_offset: UINT64, src_buffer: &T1, src_offset: UINT64, num_bytes: UINT64) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).CopyBufferRegion(dst_buffer.iptr() as *mut _ as *mut _ , dst_offset, src_buffer.iptr() as *mut _ as *mut _ , src_offset, num_bytes) };
    ()
  }
  ...
  pub fn copy_texture_region(&self, dst: &D3D12_TEXTURE_COPY_LOCATION, dst_x: UINT, dst_y: UINT, dst_z: UINT, src: &D3D12_TEXTURE_COPY_LOCATION, src_box: Option<&D3D12_BOX>) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).CopyTextureRegion(dst, dst_x, dst_y, dst_z, src, src_box.as_ref().map(|p|*p as *const _ as *const _).unwrap_or(ptr::null())) };
    ()
  }
  ...
  pub fn copy_resource<T: HasIID, T1: HasIID>(&self, dst_resource: &T, src_resource: &T1) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).CopyResource(dst_resource.iptr() as *mut _ as *mut _ , src_resource.iptr() as *mut _ as *mut _ ) };
    ()
  }
  ...
  pub fn copy_tiles<T: HasIID, T1: HasIID>(&self, tiled_resource: &T, tile_region_start_coordinate: &D3D12_TILED_RESOURCE_COORDINATE, tile_region_size: &D3D12_TILE_REGION_SIZE, buffer: &T1, buffer_start_offset_in_bytes: UINT64, flags: D3D12_TILE_COPY_FLAGS) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).CopyTiles(tiled_resource.iptr() as *mut _ as *mut _ , tile_region_start_coordinate, tile_region_size, buffer.iptr() as *mut _ as *mut _ , buffer_start_offset_in_bytes, flags) };
    ()
  }
  ...
  pub fn resolve_subresource<T: HasIID, T1: HasIID>(&self, dst_resource: &T, dst_subresource: UINT, src_resource: &T1, src_subresource: UINT, format: DXGI_FORMAT) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).ResolveSubresource(dst_resource.iptr() as *mut _ as *mut _ , dst_subresource, src_resource.iptr() as *mut _ as *mut _ , src_subresource, format) };
    ()
  }
  ...
  pub fn ia_set_primitive_topology(&self, primitive_topology: D3D12_PRIMITIVE_TOPOLOGY) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).IASetPrimitiveTopology(primitive_topology) };
    ()
  }
  ...
  pub fn rs_set_viewports(&self, viewports: &[D3D12_VIEWPORT]) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).RSSetViewports( same_length(&[Some(viewports.len())]).expect("Arrays must have equal sizes") as UINT, slice_as_ptr(viewports)) };
    ()
  }
  ...
  pub fn rs_set_scissor_rects(&self, rects: &[D3D12_RECT]) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).RSSetScissorRects( same_length(&[Some(rects.len())]).expect("Arrays must have equal sizes") as UINT, slice_as_ptr(rects)) };
    ()
  }
  ...
  pub fn om_set_blend_factor(&self, blend_factor: Option<&[FLOAT;4]>) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).OMSetBlendFactor(blend_factor.as_ref().map(|p|*p as *const _ as *const _).unwrap_or(ptr::null())) };
    ()
  }
  ...
  pub fn om_set_stencil_ref(&self, stencil_ref: UINT) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).OMSetStencilRef(stencil_ref) };
    ()
  }
  ...
  pub fn set_pipeline_state<T: HasIID>(&self, pipeline_state: &T) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).SetPipelineState(pipeline_state.iptr() as *mut _ as *mut _ ) };
    ()
  }
  ...
  pub fn resource_barrier(&self, barriers: &[D3D12_RESOURCE_BARRIER]) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).ResourceBarrier( same_length(&[Some(barriers.len())]).expect("Arrays must have equal sizes") as UINT, slice_as_ptr(barriers)) };
    ()
  }
  ...
  pub fn execute_bundle<T: HasIID>(&self, command_list: &T) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).ExecuteBundle(command_list.iptr() as *mut _ as *mut _ ) };
    ()
  }
  ...
  pub fn set_descriptor_heaps<T: HasIID>(&self, descriptor_heaps: &[&T]) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).SetDescriptorHeaps( same_length(&[Some(descriptor_heaps.len())]).expect("Arrays must have equal sizes") as UINT, lv1.as_mut_ptr() as *mut *mut _ as *mut *mut _) };
    ()
  }
  ...
  pub fn set_compute_root_signature<T: HasIID>(&self, root_signature: &T) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).SetComputeRootSignature(root_signature.iptr() as *mut _ as *mut _ ) };
    ()
  }
  ...
  pub fn set_graphics_root_signature<T: HasIID>(&self, root_signature: &T) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).SetGraphicsRootSignature(root_signature.iptr() as *mut _ as *mut _ ) };
    ()
  }
  ...
  pub fn set_compute_root_descriptor_table(&self, root_parameter_index: UINT, base_descriptor: D3D12_GPU_DESCRIPTOR_HANDLE) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).SetComputeRootDescriptorTable(root_parameter_index, base_descriptor) };
    ()
  }
  ...
  pub fn set_graphics_root_descriptor_table(&self, root_parameter_index: UINT, base_descriptor: D3D12_GPU_DESCRIPTOR_HANDLE) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).SetGraphicsRootDescriptorTable(root_parameter_index, base_descriptor) };
    ()
  }
  ...
  pub fn set_compute_root32_bit_constant(&self, root_parameter_index: UINT, src_data: UINT, dest_offset_in32_bit_values: UINT) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).SetComputeRoot32BitConstant(root_parameter_index, src_data, dest_offset_in32_bit_values) };
    ()
  }
  ...
  pub fn set_graphics_root32_bit_constant(&self, root_parameter_index: UINT, src_data: UINT, dest_offset_in32_bit_values: UINT) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).SetGraphicsRoot32BitConstant(root_parameter_index, src_data, dest_offset_in32_bit_values) };
    ()
  }
  ...
  pub fn set_compute_root32_bit_constants<T>(&self, root_parameter_index: UINT, src_data: &[T], dest_offset_in32_bit_values: UINT) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).SetComputeRoot32BitConstants(root_parameter_index, (mem::size_of_val(src_data)/4) as UINT, src_data.as_ptr() as *const _, dest_offset_in32_bit_values) };
    ()
  }
  ...
  pub fn set_graphics_root32_bit_constants<T>(&self, root_parameter_index: UINT, src_data: &[T], dest_offset_in32_bit_values: UINT) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).SetGraphicsRoot32BitConstants(root_parameter_index, (mem::size_of_val(src_data)/4) as UINT, src_data.as_ptr() as *const _, dest_offset_in32_bit_values) };
    ()
  }
  ...
  pub fn set_compute_root_constant_buffer_view(&self, root_parameter_index: UINT, buffer_location: D3D12_GPU_VIRTUAL_ADDRESS) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).SetComputeRootConstantBufferView(root_parameter_index, buffer_location) };
    ()
  }
  ...
  pub fn set_graphics_root_constant_buffer_view(&self, root_parameter_index: UINT, buffer_location: D3D12_GPU_VIRTUAL_ADDRESS) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).SetGraphicsRootConstantBufferView(root_parameter_index, buffer_location) };
    ()
  }
  ...
  pub fn set_compute_root_shader_resource_view(&self, root_parameter_index: UINT, buffer_location: D3D12_GPU_VIRTUAL_ADDRESS) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).SetComputeRootShaderResourceView(root_parameter_index, buffer_location) };
    ()
  }
  ...
  pub fn set_graphics_root_shader_resource_view(&self, root_parameter_index: UINT, buffer_location: D3D12_GPU_VIRTUAL_ADDRESS) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).SetGraphicsRootShaderResourceView(root_parameter_index, buffer_location) };
    ()
  }
  ...
  pub fn set_compute_root_unordered_access_view(&self, root_parameter_index: UINT, buffer_location: D3D12_GPU_VIRTUAL_ADDRESS) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).SetComputeRootUnorderedAccessView(root_parameter_index, buffer_location) };
    ()
  }
  ...
  pub fn set_graphics_root_unordered_access_view(&self, root_parameter_index: UINT, buffer_location: D3D12_GPU_VIRTUAL_ADDRESS) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).SetGraphicsRootUnorderedAccessView(root_parameter_index, buffer_location) };
    ()
  }
  ...
  pub fn ia_set_index_buffer(&self, view: Option<&D3D12_INDEX_BUFFER_VIEW>) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).IASetIndexBuffer(view.as_ref().map(|p|*p as *const _ as *const _).unwrap_or(ptr::null())) };
    ()
  }
  ...
  pub fn ia_set_vertex_buffers(&self, start_slot: UINT, views: Option<&[D3D12_VERTEX_BUFFER_VIEW]>) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).IASetVertexBuffers(start_slot,  same_length(&[views.as_ref().map(|a|a.len())]).expect("Arrays must have equal sizes") as UINT, opt_arr_as_ptr(&views) as *const _) };
    ()
  }
  ...
  pub fn so_set_targets(&self, start_slot: UINT, views: Option<&[D3D12_STREAM_OUTPUT_BUFFER_VIEW]>) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).SOSetTargets(start_slot,  same_length(&[views.as_ref().map(|a|a.len())]).expect("Arrays must have equal sizes") as UINT, opt_arr_as_ptr(&views) as *const _) };
    ()
  }
  ...
  pub fn om_set_render_targets(&self, num_render_target_descriptors: UINT, render_target_descriptors: &D3D12_CPU_DESCRIPTOR_HANDLE, depth_stencil_descriptor: Option<&D3D12_CPU_DESCRIPTOR_HANDLE>) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).OMSetRenderTargets(num_render_target_descriptors, render_target_descriptors, TRUE, depth_stencil_descriptor.as_ref().map(|p|*p as *const _ as *const _).unwrap_or(ptr::null())) };
    ()
  }
  ...
  pub fn om_set_render_targets_arr(&self, render_target_descriptors: &[D3D12_CPU_DESCRIPTOR_HANDLE], depth_stencil_descriptor: Option<&D3D12_CPU_DESCRIPTOR_HANDLE>) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).OMSetRenderTargets( same_length(&[Some(render_target_descriptors.len())]).expect("Arrays must have equal sizes") as UINT, slice_as_ptr(render_target_descriptors), FALSE, depth_stencil_descriptor.as_ref().map(|p|*p as *const _ as *const _).unwrap_or(ptr::null())) };
    ()
  }
  ...
  pub fn clear_depth_stencil_view(&self, depth_stencil_view: D3D12_CPU_DESCRIPTOR_HANDLE, clear_flags: D3D12_CLEAR_FLAGS, depth: FLOAT, stencil: UINT8, rects: &[D3D12_RECT]) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).ClearDepthStencilView(depth_stencil_view, clear_flags, depth, stencil,  same_length(&[Some(rects.len())]).expect("Arrays must have equal sizes") as UINT, slice_as_ptr(rects)) };
    ()
  }
  ...
  pub fn clear_render_target_view(&self, render_target_view: D3D12_CPU_DESCRIPTOR_HANDLE, color_r_g_b_a: &[FLOAT;4], rects: &[D3D12_RECT]) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).ClearRenderTargetView(render_target_view, color_r_g_b_a,  same_length(&[Some(rects.len())]).expect("Arrays must have equal sizes") as UINT, slice_as_ptr(rects)) };
    ()
  }
  ...
  pub fn clear_unordered_access_view_uint<T: HasIID>(&self, view_gpu_handle_in_current_heap: D3D12_GPU_DESCRIPTOR_HANDLE, view_cpu_handle: D3D12_CPU_DESCRIPTOR_HANDLE, resource: &T, values: &[UINT;4], rects: &[D3D12_RECT]) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).ClearUnorderedAccessViewUint(view_gpu_handle_in_current_heap, view_cpu_handle, resource.iptr() as *mut _ as *mut _ , values,  same_length(&[Some(rects.len())]).expect("Arrays must have equal sizes") as UINT, slice_as_ptr(rects)) };
    ()
  }
  ...
  pub fn clear_unordered_access_view_float<T: HasIID>(&self, view_gpu_handle_in_current_heap: D3D12_GPU_DESCRIPTOR_HANDLE, view_cpu_handle: D3D12_CPU_DESCRIPTOR_HANDLE, resource: &T, values: &[FLOAT;4], rects: &[D3D12_RECT]) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).ClearUnorderedAccessViewFloat(view_gpu_handle_in_current_heap, view_cpu_handle, resource.iptr() as *mut _ as *mut _ , values,  same_length(&[Some(rects.len())]).expect("Arrays must have equal sizes") as UINT, slice_as_ptr(rects)) };
    ()
  }
  ...
  pub fn discard_resource<T: HasIID>(&self, resource: &T, region: Option<&D3D12_DISCARD_REGION>) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).DiscardResource(resource.iptr() as *mut _ as *mut _ , region.as_ref().map(|p|*p as *const _ as *const _).unwrap_or(ptr::null())) };
    ()
  }
  ...
  pub fn begin_query<T: HasIID>(&self, query_heap: &T, type_: D3D12_QUERY_TYPE, index: UINT) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).BeginQuery(query_heap.iptr() as *mut _ as *mut _ , type_, index) };
    ()
  }
  ...
  pub fn end_query<T: HasIID>(&self, query_heap: &T, type_: D3D12_QUERY_TYPE, index: UINT) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).EndQuery(query_heap.iptr() as *mut _ as *mut _ , type_, index) };
    ()
  }
  ...
  pub fn resolve_query_data<T: HasIID, T1: HasIID>(&self, query_heap: &T, type_: D3D12_QUERY_TYPE, start_index: UINT, num_queries: UINT, destination_buffer: &T1, aligned_destination_buffer_offset: UINT64) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).ResolveQueryData(query_heap.iptr() as *mut _ as *mut _ , type_, start_index, num_queries, destination_buffer.iptr() as *mut _ as *mut _ , aligned_destination_buffer_offset) };
    ()
  }
  ...
  pub fn set_predication(&self, buffer: Option<&D3D12Resource>, aligned_buffer_offset: UINT64, operation: D3D12_PREDICATION_OP) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).SetPredication(buffer.map(|i|i.iptr()).unwrap_or(ptr::null_mut()) as *mut _ as *mut _, aligned_buffer_offset, operation) };
    ()
  }
  ...
  pub fn execute_indirect<T: HasIID, T1: HasIID, T2: HasIID>(&self, command_signature: &T, max_command_count: UINT, argument_buffer: &T1, argument_buffer_offset: UINT64, count_buffer: &T2, count_buffer_offset: UINT64) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12GraphicsCommandList)).ExecuteIndirect(command_signature.iptr() as *mut _ as *mut _ , max_command_count, argument_buffer.iptr() as *mut _ as *mut _ , argument_buffer_offset, count_buffer.iptr() as *mut _ as *mut _ , count_buffer_offset) };
    ()
  }
...
impl D3D12Heap {
  ...
  pub unsafe fn get_private_data<T>(&self, guid: &GUID, data: Option<&mut T>) -> HResult<UINT> {
    let mut lv1: UINT = data.as_ref().map(|v|mem::size_of_val(*v)).unwrap_or(0) as UINT;
    let hr=unsafe { (*(self.0 as *mut ID3D12Heap)).GetPrivateData(guid, &mut lv1, data.map(|v|v as *const _ as *mut _).unwrap_or(ptr::null_mut())) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn set_private_data<T>(&self, guid: &GUID, data: &T) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12Heap)).SetPrivateData(guid, mem::size_of_val(data) as UINT, data as *const _ as *const _) };
    hr2ret(hr,hr)
  }
  ...
  pub fn set_name(&self, name: Cow<str>) -> HResult<HRESULT> {
    let lv1: Vec<u16> = str_to_vec_u16(name);
    let hr=unsafe { (*(self.0 as *mut ID3D12Heap)).SetName(lv1.as_ptr() as LPCWSTR) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_device<T: HasIID>(&self) -> HResult<T> {
    let mut lv1: *mut IUnknown = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut ID3D12Heap)).GetDevice(T::iid(), &mut lv1 as *mut *mut _ as *mut *mut c_void) };
    hr2ret(hr,T::new(lv1))
  }
  ...
  pub fn get_desc(&self) -> D3D12_HEAP_DESC {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12Heap)).GetDesc(&mut lv1 as *mut _ as *mut _) };
    lv1
  }
...
impl D3D12Object {
  ...
  pub unsafe fn get_private_data<T>(&self, guid: &GUID, data: Option<&mut T>) -> HResult<UINT> {
    let mut lv1: UINT = data.as_ref().map(|v|mem::size_of_val(*v)).unwrap_or(0) as UINT;
    let hr=unsafe { (*(self.0 as *mut ID3D12Object)).GetPrivateData(guid, &mut lv1, data.map(|v|v as *const _ as *mut _).unwrap_or(ptr::null_mut())) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn set_private_data<T>(&self, guid: &GUID, data: &T) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12Object)).SetPrivateData(guid, mem::size_of_val(data) as UINT, data as *const _ as *const _) };
    hr2ret(hr,hr)
  }
  ...
  pub fn set_name(&self, name: Cow<str>) -> HResult<HRESULT> {
    let lv1: Vec<u16> = str_to_vec_u16(name);
    let hr=unsafe { (*(self.0 as *mut ID3D12Object)).SetName(lv1.as_ptr() as LPCWSTR) };
    hr2ret(hr,hr)
  }
...
impl D3D12Pageable {
  ...
  pub unsafe fn get_private_data<T>(&self, guid: &GUID, data: Option<&mut T>) -> HResult<UINT> {
    let mut lv1: UINT = data.as_ref().map(|v|mem::size_of_val(*v)).unwrap_or(0) as UINT;
    let hr=unsafe { (*(self.0 as *mut ID3D12Pageable)).GetPrivateData(guid, &mut lv1, data.map(|v|v as *const _ as *mut _).unwrap_or(ptr::null_mut())) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn set_private_data<T>(&self, guid: &GUID, data: &T) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12Pageable)).SetPrivateData(guid, mem::size_of_val(data) as UINT, data as *const _ as *const _) };
    hr2ret(hr,hr)
  }
  ...
  pub fn set_name(&self, name: Cow<str>) -> HResult<HRESULT> {
    let lv1: Vec<u16> = str_to_vec_u16(name);
    let hr=unsafe { (*(self.0 as *mut ID3D12Pageable)).SetName(lv1.as_ptr() as LPCWSTR) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_device<T: HasIID>(&self) -> HResult<T> {
    let mut lv1: *mut IUnknown = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut ID3D12Pageable)).GetDevice(T::iid(), &mut lv1 as *mut *mut _ as *mut *mut c_void) };
    hr2ret(hr,T::new(lv1))
  }
...
impl D3D12PipelineState {
  ...
  pub unsafe fn get_private_data<T>(&self, guid: &GUID, data: Option<&mut T>) -> HResult<UINT> {
    let mut lv1: UINT = data.as_ref().map(|v|mem::size_of_val(*v)).unwrap_or(0) as UINT;
    let hr=unsafe { (*(self.0 as *mut ID3D12PipelineState)).GetPrivateData(guid, &mut lv1, data.map(|v|v as *const _ as *mut _).unwrap_or(ptr::null_mut())) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn set_private_data<T>(&self, guid: &GUID, data: &T) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12PipelineState)).SetPrivateData(guid, mem::size_of_val(data) as UINT, data as *const _ as *const _) };
    hr2ret(hr,hr)
  }
  ...
  pub fn set_name(&self, name: Cow<str>) -> HResult<HRESULT> {
    let lv1: Vec<u16> = str_to_vec_u16(name);
    let hr=unsafe { (*(self.0 as *mut ID3D12PipelineState)).SetName(lv1.as_ptr() as LPCWSTR) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_device<T: HasIID>(&self) -> HResult<T> {
    let mut lv1: *mut IUnknown = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut ID3D12PipelineState)).GetDevice(T::iid(), &mut lv1 as *mut *mut _ as *mut *mut c_void) };
    hr2ret(hr,T::new(lv1))
  }
...
impl D3D12QueryHeap {
  ...
  pub unsafe fn get_private_data<T>(&self, guid: &GUID, data: Option<&mut T>) -> HResult<UINT> {
    let mut lv1: UINT = data.as_ref().map(|v|mem::size_of_val(*v)).unwrap_or(0) as UINT;
    let hr=unsafe { (*(self.0 as *mut ID3D12QueryHeap)).GetPrivateData(guid, &mut lv1, data.map(|v|v as *const _ as *mut _).unwrap_or(ptr::null_mut())) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn set_private_data<T>(&self, guid: &GUID, data: &T) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12QueryHeap)).SetPrivateData(guid, mem::size_of_val(data) as UINT, data as *const _ as *const _) };
    hr2ret(hr,hr)
  }
  ...
  pub fn set_name(&self, name: Cow<str>) -> HResult<HRESULT> {
    let lv1: Vec<u16> = str_to_vec_u16(name);
    let hr=unsafe { (*(self.0 as *mut ID3D12QueryHeap)).SetName(lv1.as_ptr() as LPCWSTR) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_device<T: HasIID>(&self) -> HResult<T> {
    let mut lv1: *mut IUnknown = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut ID3D12QueryHeap)).GetDevice(T::iid(), &mut lv1 as *mut *mut _ as *mut *mut c_void) };
    hr2ret(hr,T::new(lv1))
  }
...
impl D3D12Resource {
  ...
  pub unsafe fn get_private_data<T>(&self, guid: &GUID, data: Option<&mut T>) -> HResult<UINT> {
    let mut lv1: UINT = data.as_ref().map(|v|mem::size_of_val(*v)).unwrap_or(0) as UINT;
    let hr=unsafe { (*(self.0 as *mut ID3D12Resource)).GetPrivateData(guid, &mut lv1, data.map(|v|v as *const _ as *mut _).unwrap_or(ptr::null_mut())) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn set_private_data<T>(&self, guid: &GUID, data: &T) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12Resource)).SetPrivateData(guid, mem::size_of_val(data) as UINT, data as *const _ as *const _) };
    hr2ret(hr,hr)
  }
  ...
  pub fn set_name(&self, name: Cow<str>) -> HResult<HRESULT> {
    let lv1: Vec<u16> = str_to_vec_u16(name);
    let hr=unsafe { (*(self.0 as *mut ID3D12Resource)).SetName(lv1.as_ptr() as LPCWSTR) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_device<T: HasIID>(&self) -> HResult<T> {
    let mut lv1: *mut IUnknown = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut ID3D12Resource)).GetDevice(T::iid(), &mut lv1 as *mut *mut _ as *mut *mut c_void) };
    hr2ret(hr,T::new(lv1))
  }
  ...
  pub unsafe fn map<T>(&self, subresource: UINT, read_range: Option<&D3D12_RANGE>, data: Option<&mut *mut T>) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12Resource)).Map(subresource, read_range.as_ref().map(|p|*p as *const _ as *const _).unwrap_or(ptr::null()), opt_as_mut_ptr(&data) as *mut *mut _) };
    hr2ret(hr,hr)
  }
  ...
  pub fn unmap(&self, subresource: UINT, written_range: Option<&D3D12_RANGE>) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12Resource)).Unmap(subresource, written_range.as_ref().map(|p|*p as *const _ as *const _).unwrap_or(ptr::null())) };
    ()
  }
  ...
  pub fn get_desc(&self) -> D3D12_RESOURCE_DESC {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12Resource)).GetDesc(&mut lv1 as *mut _ as *mut _) };
    lv1
  }
  ...
  pub fn get_gpu_virtual_address(&self) -> D3D12_GPU_VIRTUAL_ADDRESS {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12Resource)).GetGPUVirtualAddress() };
    hr
  }
  ...
  pub unsafe fn write_to_subresource<T>(&self, dst_subresource: UINT, dst_box: Option<&D3D12_BOX>, src_data: &[T], src_row_pitch: UINT, src_depth_pitch: UINT) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12Resource)).WriteToSubresource(dst_subresource, dst_box.as_ref().map(|p|*p as *const _ as *const _).unwrap_or(ptr::null()), src_data.as_ptr() as *const _, src_row_pitch, src_depth_pitch) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_heap_properties(&self, heap_properties: Option<&mut D3D12_HEAP_PROPERTIES>, heap_flags: Option<&mut D3D12_HEAP_FLAGS>) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12Resource)).GetHeapProperties(opt_as_mut_ptr(&heap_properties), opt_as_mut_ptr(&heap_flags)) };
    hr2ret(hr,hr)
  }
...
impl D3D12RootSignatureDeserializer {
  ...
  pub fn get_root_signature_desc(&self) -> *const D3D12_ROOT_SIGNATURE_DESC {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12RootSignatureDeserializer)).GetRootSignatureDesc() };
    hr
  }
...
impl D3D12RootSignature {
  ...
  pub unsafe fn get_private_data<T>(&self, guid: &GUID, data: Option<&mut T>) -> HResult<UINT> {
    let mut lv1: UINT = data.as_ref().map(|v|mem::size_of_val(*v)).unwrap_or(0) as UINT;
    let hr=unsafe { (*(self.0 as *mut ID3D12RootSignature)).GetPrivateData(guid, &mut lv1, data.map(|v|v as *const _ as *mut _).unwrap_or(ptr::null_mut())) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn set_private_data<T>(&self, guid: &GUID, data: &T) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut ID3D12RootSignature)).SetPrivateData(guid, mem::size_of_val(data) as UINT, data as *const _ as *const _) };
    hr2ret(hr,hr)
  }
  ...
  pub fn set_name(&self, name: Cow<str>) -> HResult<HRESULT> {
    let lv1: Vec<u16> = str_to_vec_u16(name);
    let hr=unsafe { (*(self.0 as *mut ID3D12RootSignature)).SetName(lv1.as_ptr() as LPCWSTR) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_device<T: HasIID>(&self) -> HResult<T> {
    let mut lv1: *mut IUnknown = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut ID3D12RootSignature)).GetDevice(T::iid(), &mut lv1 as *mut *mut _ as *mut *mut c_void) };
    hr2ret(hr,T::new(lv1))
  }
