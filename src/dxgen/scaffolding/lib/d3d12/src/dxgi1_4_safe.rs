...
impl DXGIAdapter3 {
  ...
  pub fn set_private_data<T>(&self, name: &GUID, data: &T) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGIAdapter3)).SetPrivateData(name, mem::size_of_val(data) as UINT, data as *const _ as *const _) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_private_data<T>(&self, name: &GUID, data: Option<&mut T>) -> HResult<UINT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGIAdapter3)).GetPrivateData(name, &mut lv1, data.map(|v|v as *const _ as *mut _).unwrap_or(ptr::null_mut())) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn get_parent<T: HasIID>(&self) -> HResult<T> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGIAdapter3)).GetParent(T::iid(), &mut lv1 as *mut *mut _ as *mut *mut c_void) };
    hr2ret(hr,T::new(lv1))
  }
  ...
  pub fn enum_outputs(&self, output: UINT) -> HResult<DXGIOutput> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGIAdapter3)).EnumOutputs(output, &mut lv1 as *mut *mut _) };
  ...
  pub fn get_desc(&self) -> HResult<DXGI_ADAPTER_DESC> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGIAdapter3)).GetDesc(&mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn check_interface_support(&self, interface_name: &GUID) -> HResult<LARGE_INTEGER> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGIAdapter3)).CheckInterfaceSupport(interface_name, &mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn get_desc1(&self) -> HResult<DXGI_ADAPTER_DESC1> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGIAdapter3)).GetDesc1(&mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn get_desc2(&self) -> HResult<DXGI_ADAPTER_DESC2> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGIAdapter3)).GetDesc2(&mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
...
impl DXGIFactory4 {
  ...
  pub fn set_private_data<T>(&self, name: &GUID, data: &T) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGIFactory4)).SetPrivateData(name, mem::size_of_val(data) as UINT, data as *const _ as *const _) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_private_data<T>(&self, name: &GUID, data: Option<&mut T>) -> HResult<UINT> {
    let mut lv1: UINT = data.as_ref().map(|v|mem::size_of_val(*v)).unwrap_or(0) as UINT;
    let hr=unsafe { (*(self.0 as *mut IDXGIFactory4)).GetPrivateData(name, &mut lv1, data.map(|v|v as *const _ as *mut _).unwrap_or(ptr::null_mut())) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn get_parent<T: HasIID>(&self) -> HResult<T> {
    let mut lv1: *mut IUnknown = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut IDXGIFactory4)).GetParent(T::iid(), &mut lv1 as *mut *mut _ as *mut *mut c_void) };
    hr2ret(hr,T::new(lv1))
  }
  ...
  pub fn enum_adapters(&self, adapter: UINT) -> HResult<DXGIAdapter> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGIFactory4)).EnumAdapters(adapter, &mut lv1 as *mut *mut _) };
  ...
  pub fn make_window_association(&self, window_handle: HWND, flags: UINT) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGIFactory4)).MakeWindowAssociation(window_handle, flags) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_window_association(&self) -> HResult<HWND> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGIFactory4)).GetWindowAssociation(&mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn create_swap_chain<T: HasIID>(&self, device: &T, desc: &mut DXGI_SWAP_CHAIN_DESC) -> HResult<DXGISwapChain> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGIFactory4)).CreateSwapChain(device.iptr() as *mut _ as *mut _ , desc, &mut lv1 as *mut *mut _) };
  ...
  pub fn create_software_adapter(&self, module: HMODULE) -> HResult<DXGIAdapter> {
    let mut lv1: *mut IDXGIAdapter = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut IDXGIFactory4)).CreateSoftwareAdapter(module, &mut lv1 as *mut *mut _) };
    hr2ret(hr,DXGIAdapter::new(lv1 as *mut _))
  }
  ...
  pub fn enum_adapters1(&self, adapter: UINT) -> HResult<DXGIAdapter1> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGIFactory4)).EnumAdapters1(adapter, &mut lv1 as *mut *mut _) };
  ...
  pub fn is_current(&self) -> BOOL {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGIFactory4)).IsCurrent() };
    hr
  }
  ...
  pub fn is_windowed_stereo_enabled(&self) -> BOOL {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGIFactory4)).IsWindowedStereoEnabled() };
    hr
  }
  ...
  pub fn create_swap_chain_for_hwnd<T: HasIID>(&self, device: &T, hWnd: HWND, desc: &DXGI_SWAP_CHAIN_DESC1, fullscreen_desc: Option<&DXGI_SWAP_CHAIN_FULLSCREEN_DESC>, restrict_to_output: Option<&DXGIOutput>) -> HResult<DXGISwapChain1> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGIFactory4)).CreateSwapChainForHwnd(device.iptr() as *mut _ as *mut _ , hWnd, desc, fullscreen_desc.as_ref().map(|p|*p as *const _ as *const _).unwrap_or(ptr::null()), restrict_to_output.map(|i|i.iptr()).unwrap_or(ptr::null_mut()) as *mut _ as *mut _, &mut lv1 as *mut *mut _) };
  ...
  pub fn create_swap_chain_for_core_window<T: HasIID, T1: HasIID>(&self, device: &T, window: &T1, desc: &DXGI_SWAP_CHAIN_DESC1, restrict_to_output: Option<&DXGIOutput>) -> HResult<DXGISwapChain1> {
    let mut lv1: *mut IDXGISwapChain1 = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut IDXGIFactory4)).CreateSwapChainForCoreWindow(device.iptr() as *mut _ as *mut _ , window.iptr() as *mut _ as *mut _ , desc, restrict_to_output.map(|i|i.iptr()).unwrap_or(ptr::null_mut()) as *mut _ as *mut _, &mut lv1 as *mut *mut _) };
    hr2ret(hr,DXGISwapChain1::new(lv1 as *mut _))
  }
  ...
  pub fn get_shared_resource_adapter_luid(&self, hResource: HANDLE) -> HResult<LUID> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGIFactory4)).GetSharedResourceAdapterLuid(hResource, &mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn register_stereo_status_window(&self, window_handle: HWND, wMsg: UINT) -> HResult<DWORD> {
    let mut lv1: DWORD = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut IDXGIFactory4)).RegisterStereoStatusWindow(window_handle, wMsg, &mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn register_stereo_status_event(&self, hEvent: HANDLE) -> HResult<DWORD> {
    let mut lv1: DWORD = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut IDXGIFactory4)).RegisterStereoStatusEvent(hEvent, &mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn unregister_stereo_status(&self, cookie: DWORD) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGIFactory4)).UnregisterStereoStatus(cookie) };
    ()
  }
  ...
  pub fn register_occlusion_status_window(&self, window_handle: HWND, wMsg: UINT) -> HResult<DWORD> {
    let mut lv1: DWORD = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut IDXGIFactory4)).RegisterOcclusionStatusWindow(window_handle, wMsg, &mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn register_occlusion_status_event(&self, hEvent: HANDLE) -> HResult<DWORD> {
    let mut lv1: DWORD = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut IDXGIFactory4)).RegisterOcclusionStatusEvent(hEvent, &mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn unregister_occlusion_status(&self, cookie: DWORD) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGIFactory4)).UnregisterOcclusionStatus(cookie) };
    ()
  }
  ...
  pub fn create_swap_chain_for_composition<T: HasIID>(&self, device: &T, desc: &DXGI_SWAP_CHAIN_DESC1, restrict_to_output: Option<&DXGIOutput>) -> HResult<DXGISwapChain1> {
    let mut lv1: *mut IDXGISwapChain1 = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut IDXGIFactory4)).CreateSwapChainForComposition(device.iptr() as *mut _ as *mut _ , desc, restrict_to_output.map(|i|i.iptr()).unwrap_or(ptr::null_mut()) as *mut _ as *mut _, &mut lv1 as *mut *mut _) };
    hr2ret(hr,DXGISwapChain1::new(lv1 as *mut _))
  }
  ...
  pub fn get_creation_flags(&self) -> UINT {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGIFactory4)).GetCreationFlags() };
    hr
  }
...
impl DXGIOutput4 {
  ...
  pub fn set_private_data<T>(&self, name: &GUID, data: &T) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGIOutput4)).SetPrivateData(name, mem::size_of_val(data) as UINT, data as *const _ as *const _) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_private_data<T>(&self, name: &GUID, data: Option<&mut T>) -> HResult<UINT> {
    let mut lv1: UINT = data.as_ref().map(|v|mem::size_of_val(*v)).unwrap_or(0) as UINT;
    let hr=unsafe { (*(self.0 as *mut IDXGIOutput4)).GetPrivateData(name, &mut lv1, data.map(|v|v as *const _ as *mut _).unwrap_or(ptr::null_mut())) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn get_parent<T: HasIID>(&self) -> HResult<T> {
    let mut lv1: *mut IUnknown = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut IDXGIOutput4)).GetParent(T::iid(), &mut lv1 as *mut *mut _ as *mut *mut c_void) };
    hr2ret(hr,T::new(lv1))
  }
  ...
  pub fn get_desc(&self) -> HResult<DXGI_OUTPUT_DESC> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGIOutput4)).GetDesc(&mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn get_display_mode_list(&self, enum_format: DXGI_FORMAT, flags: UINT, desc: Option<&mut [DXGI_MODE_DESC]>) -> HResult<UINT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGIOutput4)).GetDisplayModeList(enum_format, flags, &mut lv1, opt_arr_as_mut_ptr(&desc) as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn find_closest_matching_mode(&self, mode_to_match: &DXGI_MODE_DESC, concerned_device: Option<&Unknown>) -> HResult<DXGI_MODE_DESC> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGIOutput4)).FindClosestMatchingMode(mode_to_match, &mut lv1 as *mut _ as *mut _, concerned_device.map(|i|i.iptr()).unwrap_or(ptr::null_mut()) as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn wait_for_v_blank(&self) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGIOutput4)).WaitForVBlank() };
    hr2ret(hr,hr)
  }
  ...
  pub fn take_ownership<T: HasIID>(&self, device: &T, exclusive: BOOL) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGIOutput4)).TakeOwnership(device.iptr() as *mut _ as *mut _ , exclusive) };
    hr2ret(hr,hr)
  }
  ...
  pub fn release_ownership(&self) -> () {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGIOutput4)).ReleaseOwnership() };
    ()
  }
  ...
  pub fn get_gamma_control_capabilities(&self) -> HResult<DXGI_GAMMA_CONTROL_CAPABILITIES> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGIOutput4)).GetGammaControlCapabilities(&mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn set_gamma_control(&self, array: &DXGI_GAMMA_CONTROL) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGIOutput4)).SetGammaControl(array) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_gamma_control(&self) -> HResult<DXGI_GAMMA_CONTROL> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGIOutput4)).GetGammaControl(&mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn set_display_surface<T: HasIID>(&self, scanout_surface: &T) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGIOutput4)).SetDisplaySurface(scanout_surface.iptr() as *mut _ as *mut _ ) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_display_surface_data<T: HasIID>(&self, destination: &T) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGIOutput4)).GetDisplaySurfaceData(destination.iptr() as *mut _ as *mut _ ) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_frame_statistics(&self) -> HResult<DXGI_FRAME_STATISTICS> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGIOutput4)).GetFrameStatistics(&mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn get_display_mode_list1(&self, enum_format: DXGI_FORMAT, flags: UINT, desc: Option<&mut [DXGI_MODE_DESC1]>) -> HResult<UINT> {
    let mut lv1: UINT = desc.as_ref().map(|v|v.len()).unwrap_or(0) as UINT;
    let hr=unsafe { (*(self.0 as *mut IDXGIOutput4)).GetDisplayModeList1(enum_format, flags, &mut lv1, opt_arr_as_mut_ptr(&desc) as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn find_closest_matching_mode1(&self, mode_to_match: &DXGI_MODE_DESC1, closest_match: &mut DXGI_MODE_DESC1, concerned_device: Option<&Unknown>) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGIOutput4)).FindClosestMatchingMode1(mode_to_match, closest_match, concerned_device.map(|i|i.iptr()).unwrap_or(ptr::null_mut()) as *mut _ as *mut _) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_display_surface_data1<T: HasIID>(&self, destination: &T) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGIOutput4)).GetDisplaySurfaceData1(destination.iptr() as *mut _ as *mut _ ) };
    hr2ret(hr,hr)
  }
  ...
  pub fn duplicate_output<T: HasIID>(&self, device: &T) -> HResult<DXGIOutputDuplication> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGIOutput4)).DuplicateOutput(device.iptr() as *mut _ as *mut _ , &mut lv1 as *mut *mut _) };
  ...
  pub fn supports_overlays(&self) -> BOOL {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGIOutput4)).SupportsOverlays() };
    hr
  }
  ...
  pub fn check_overlay_support<T: HasIID>(&self, enum_format: DXGI_FORMAT, concerned_device: &T) -> HResult<UINT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGIOutput4)).CheckOverlaySupport(enum_format, concerned_device.iptr() as *mut _ as *mut _ , &mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
...
impl DXGISwapChain3 {
  ...
  pub fn set_private_data<T>(&self, name: &GUID, data: &T) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGISwapChain3)).SetPrivateData(name, mem::size_of_val(data) as UINT, data as *const _ as *const _) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_private_data<T>(&self, name: &GUID, data: Option<&mut T>) -> HResult<UINT> {
    let mut lv1: UINT = data.as_ref().map(|v|mem::size_of_val(*v)).unwrap_or(0) as UINT;
    let hr=unsafe { (*(self.0 as *mut IDXGISwapChain3)).GetPrivateData(name, &mut lv1, data.map(|v|v as *const _ as *mut _).unwrap_or(ptr::null_mut())) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn get_parent<T: HasIID>(&self) -> HResult<T> {
    let mut lv1: *mut IUnknown = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut IDXGISwapChain3)).GetParent(T::iid(), &mut lv1 as *mut *mut _ as *mut *mut c_void) };
    hr2ret(hr,T::new(lv1))
  }
  ...
  pub fn present(&self, sync_interval: UINT, flags: UINT) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGISwapChain3)).Present(sync_interval, flags) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_buffer<T: HasIID>(&self, buffer: UINT) -> HResult<T> {
    let mut lv1: *mut IUnknown = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut IDXGISwapChain3)).GetBuffer(buffer, T::iid(), &mut lv1 as *mut *mut _ as *mut *mut c_void) };
    hr2ret(hr,T::new(lv1))
  }
  ...
  pub fn set_fullscreen_state(&self, fullscreen: BOOL, target: Option<&DXGIOutput>) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGISwapChain3)).SetFullscreenState(fullscreen, target.map(|i|i.iptr()).unwrap_or(ptr::null_mut()) as *mut _ as *mut _) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_fullscreen_state(&self, fullscreen: Option<&mut BOOL>) -> HResult<DXGIOutput> {
    let mut lv1: *mut IDXGIOutput = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut IDXGISwapChain3)).GetFullscreenState(opt_as_mut_ptr(&fullscreen), &mut lv1 as *mut *mut _) };
    hr2ret(hr,DXGIOutput::new(lv1 as *mut _))
  }
  ...
  pub fn get_desc(&self) -> HResult<DXGI_SWAP_CHAIN_DESC> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGISwapChain3)).GetDesc(&mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn resize_buffers(&self, buffer_count: UINT, width: UINT, height: UINT, new_format: DXGI_FORMAT, swap_chain_flags: UINT) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGISwapChain3)).ResizeBuffers(buffer_count, width, height, new_format, swap_chain_flags) };
    hr2ret(hr,hr)
  }
  ...
  pub fn resize_target(&self, new_target_parameters: &DXGI_MODE_DESC) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGISwapChain3)).ResizeTarget(new_target_parameters) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_containing_output(&self) -> HResult<DXGIOutput> {
    let mut lv1: *mut IDXGIOutput = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut IDXGISwapChain3)).GetContainingOutput(&mut lv1 as *mut *mut _) };
    hr2ret(hr,DXGIOutput::new(lv1 as *mut _))
  }
  ...
  pub fn get_frame_statistics(&self) -> HResult<DXGI_FRAME_STATISTICS> {
    let mut lv1: DXGI_FRAME_STATISTICS = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut IDXGISwapChain3)).GetFrameStatistics(&mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn get_last_present_count(&self) -> HResult<UINT> {
    let mut lv1: UINT = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut IDXGISwapChain3)).GetLastPresentCount(&mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn get_desc1(&self) -> HResult<DXGI_SWAP_CHAIN_DESC1> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGISwapChain3)).GetDesc1(&mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn get_fullscreen_desc(&self) -> HResult<DXGI_SWAP_CHAIN_FULLSCREEN_DESC> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGISwapChain3)).GetFullscreenDesc(&mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn get_hwnd(&self) -> HResult<HWND> {
    let mut lv1: HWND = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut IDXGISwapChain3)).GetHwnd(&mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn get_core_window<T: HasIID>(&self) -> HResult<T> {
    let mut lv1: *mut IUnknown = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut IDXGISwapChain3)).GetCoreWindow(T::iid(), &mut lv1 as *mut *mut _ as *mut *mut c_void) };
    hr2ret(hr,T::new(lv1))
  }
  ...
  pub fn present1(&self, sync_interval: UINT, present_flags: UINT, present_parameters: &DXGI_PRESENT_PARAMETERS) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGISwapChain3)).Present1(sync_interval, present_flags, present_parameters) };
    hr2ret(hr,hr)
  }
  ...
  pub fn is_temporary_mono_supported(&self) -> BOOL {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGISwapChain3)).IsTemporaryMonoSupported() };
    hr
  }
  ...
  pub fn get_restrict_to_output(&self) -> HResult<DXGIOutput> {
    let mut lv1: *mut IDXGIOutput = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut IDXGISwapChain3)).GetRestrictToOutput(&mut lv1 as *mut *mut _) };
    hr2ret(hr,DXGIOutput::new(lv1 as *mut _))
  }
  ...
  pub fn set_background_color(&self, color: &DXGI_RGBA) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGISwapChain3)).SetBackgroundColor(color) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_background_color(&self) -> HResult<DXGI_RGBA> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGISwapChain3)).GetBackgroundColor(&mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn set_rotation(&self, rotation: DXGI_MODE_ROTATION) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGISwapChain3)).SetRotation(rotation) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_rotation(&self) -> HResult<DXGI_MODE_ROTATION> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGISwapChain3)).GetRotation(&mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn set_source_size(&self, width: UINT, height: UINT) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGISwapChain3)).SetSourceSize(width, height) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_source_size(&self) -> HResult<DSize> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGISwapChain3)).GetSourceSize(&mut (lv1.width) as *mut _ as *mut _, &mut (lv1.height) as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn set_maximum_frame_latency(&self, max_latency: UINT) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGISwapChain3)).SetMaximumFrameLatency(max_latency) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_maximum_frame_latency(&self) -> HResult<UINT> {
    let mut lv1: UINT = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut IDXGISwapChain3)).GetMaximumFrameLatency(&mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn get_frame_latency_waitable_object(&self) -> HANDLE {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGISwapChain3)).GetFrameLatencyWaitableObject() };
    hr
  }
  ...
  pub fn set_matrix_transform(&self, matrix: &DXGI_MATRIX_3X2_F) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGISwapChain3)).SetMatrixTransform(matrix) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_matrix_transform(&self) -> HResult<DXGI_MATRIX_3X2_F> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDXGISwapChain3)).GetMatrixTransform(&mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
