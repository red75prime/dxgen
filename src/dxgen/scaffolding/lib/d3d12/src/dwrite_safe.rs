...
impl DWriteBitmapRenderTarget {
  ...
  pub fn draw_glyph_run<T: HasIID>(&self, baselineOriginX: FLOAT, baselineOriginY: FLOAT, measuringMode: DWRITE_MEASURING_MODE, glyphRun: &DWRITE_GLYPH_RUN, renderingParams: &T, textColor: COLORREF, blackBoxRect: Option<&mut RECT>) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteBitmapRenderTarget)).DrawGlyphRun(baselineOriginX, baselineOriginY, measuringMode, glyphRun, renderingParams.iptr() as *mut _ as *mut _ , textColor, opt_as_mut_ptr(&blackBoxRect)) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_memory_dc(&self) -> HDC {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteBitmapRenderTarget)).GetMemoryDC() };
    hr
  }
  ...
  pub fn get_pixels_per_dip(&self) -> FLOAT {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteBitmapRenderTarget)).GetPixelsPerDip() };
    hr
  }
  ...
  pub fn set_pixels_per_dip(&self, pixelsPerDip: FLOAT) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteBitmapRenderTarget)).SetPixelsPerDip(pixelsPerDip) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_current_transform(&self) -> HResult<DWRITE_MATRIX> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteBitmapRenderTarget)).GetCurrentTransform(&mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn set_current_transform(&self, transform: &DWRITE_MATRIX) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteBitmapRenderTarget)).SetCurrentTransform(transform) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_size(&self) -> HResult<SIZE> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteBitmapRenderTarget)).GetSize(&mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn resize(&self, width: UINT32, height: UINT32) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteBitmapRenderTarget)).Resize(width, height) };
    hr2ret(hr,hr)
  }
...
impl DWriteFactory {
  ...
  pub fn get_system_font_collection(&self, checkForUpdates: BOOL) -> HResult<DWriteFontCollection> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFactory)).GetSystemFontCollection(&mut lv1 as *mut *mut _, checkForUpdates) };
    hr2ret(hr,DWriteFontCollection::new(lv1 as *mut _))
  }
  ...
  pub fn create_custom_font_collection<T: HasIID, T1>(&self, collectionLoader: &T, collectionKey: &T1) -> HResult<DWriteFontCollection> {
    let mut lv1: *mut IDWriteFontCollection = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut IDWriteFactory)).CreateCustomFontCollection(collectionLoader.iptr() as *mut _ as *mut _ , collectionKey as *const _ as *const _, mem::size_of_val(collectionKey) as UINT32, &mut lv1 as *mut *mut _) };
    hr2ret(hr,DWriteFontCollection::new(lv1 as *mut _))
  }
  ...
  pub fn register_font_collection_loader<T: HasIID>(&self, fontCollectionLoader: &T) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFactory)).RegisterFontCollectionLoader(fontCollectionLoader.iptr() as *mut _ as *mut _ ) };
    hr2ret(hr,hr)
  }
  ...
  pub fn unregister_font_collection_loader<T: HasIID>(&self, fontCollectionLoader: &T) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFactory)).UnregisterFontCollectionLoader(fontCollectionLoader.iptr() as *mut _ as *mut _ ) };
    hr2ret(hr,hr)
  }
  ...
  pub fn create_font_file_reference(&self, filePath: &WCHAR, lastWriteTime: Option<&FILETIME>) -> HResult<DWriteFontFile> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFactory)).CreateFontFileReference(filePath, lastWriteTime.as_ref().map(|p|*p as *const _ as *const _).unwrap_or(ptr::null()), &mut lv1 as *mut *mut _) };
    hr2ret(hr,DWriteFontFile::new(lv1 as *mut _))
  }
  ...
  pub fn create_custom_font_file_reference<T, T1: HasIID>(&self, fontFileReferenceKey: &T, fontFileLoader: &T1) -> HResult<DWriteFontFile> {
    let mut lv1: *mut IDWriteFontFile = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut IDWriteFactory)).CreateCustomFontFileReference(fontFileReferenceKey as *const _ as *const _, mem::size_of_val(fontFileReferenceKey) as UINT32, fontFileLoader.iptr() as *mut _ as *mut _ , &mut lv1 as *mut *mut _) };
    hr2ret(hr,DWriteFontFile::new(lv1 as *mut _))
  }
  ...
  pub fn create_font_face<T: HasIID>(&self, fontFaceType: DWRITE_FONT_FACE_TYPE, fontFiles: &[&T], faceIndex: UINT32, fontFaceSimulationFlags: DWRITE_FONT_SIMULATIONS) -> HResult<DWriteFontFace> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFactory)).CreateFontFace(fontFaceType,  same_length(&[Some(fontFiles.len())]).expect("Arrays must have equal sizes") as UINT32, lv1.as_mut_ptr() as *mut *mut _ as *mut *mut _, faceIndex, fontFaceSimulationFlags, &mut lv2 as *mut *mut _) };
    hr2ret(hr,DWriteFontFace::new(lv2 as *mut _))
  }
  ...
  pub fn create_rendering_params(&self) -> HResult<DWriteRenderingParams> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFactory)).CreateRenderingParams(&mut lv1 as *mut *mut _) };
    hr2ret(hr,DWriteRenderingParams::new(lv1 as *mut _))
  }
  ...
  pub fn create_monitor_rendering_params(&self, monitor: HMONITOR) -> HResult<DWriteRenderingParams> {
    let mut lv1: *mut IDWriteRenderingParams = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut IDWriteFactory)).CreateMonitorRenderingParams(monitor, &mut lv1 as *mut *mut _) };
    hr2ret(hr,DWriteRenderingParams::new(lv1 as *mut _))
  }
  ...
  pub fn create_custom_rendering_params(&self, gamma: FLOAT, enhancedContrast: FLOAT, clearTypeLevel: FLOAT, pixelGeometry: DWRITE_PIXEL_GEOMETRY, renderingMode: DWRITE_RENDERING_MODE) -> HResult<DWriteRenderingParams> {
    let mut lv1: *mut IDWriteRenderingParams = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut IDWriteFactory)).CreateCustomRenderingParams(gamma, enhancedContrast, clearTypeLevel, pixelGeometry, renderingMode, &mut lv1 as *mut *mut _) };
    hr2ret(hr,DWriteRenderingParams::new(lv1 as *mut _))
  }
  ...
  pub fn register_font_file_loader<T: HasIID>(&self, fontFileLoader: &T) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFactory)).RegisterFontFileLoader(fontFileLoader.iptr() as *mut _ as *mut _ ) };
    hr2ret(hr,hr)
  }
  ...
  pub fn unregister_font_file_loader<T: HasIID>(&self, fontFileLoader: &T) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFactory)).UnregisterFontFileLoader(fontFileLoader.iptr() as *mut _ as *mut _ ) };
    hr2ret(hr,hr)
  }
  ...
  pub fn create_text_format<T: HasIID>(&self, fontFamilyName: &WCHAR, fontCollection: &T, fontWeight: DWRITE_FONT_WEIGHT, fontStyle: DWRITE_FONT_STYLE, fontStretch: DWRITE_FONT_STRETCH, fontSize: FLOAT, localeName: &WCHAR) -> HResult<DWriteTextFormat> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFactory)).CreateTextFormat(fontFamilyName, fontCollection.iptr() as *mut _ as *mut _ , fontWeight, fontStyle, fontStretch, fontSize, localeName, &mut lv1 as *mut *mut _) };
    hr2ret(hr,DWriteTextFormat::new(lv1 as *mut _))
  }
  ...
  pub fn create_typography(&self) -> HResult<DWriteTypography> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFactory)).CreateTypography(&mut lv1 as *mut *mut _) };
    hr2ret(hr,DWriteTypography::new(lv1 as *mut _))
  }
  ...
  pub fn get_gdi_interop(&self) -> HResult<DWriteGdiInterop> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFactory)).GetGdiInterop(&mut lv1 as *mut *mut _) };
    hr2ret(hr,DWriteGdiInterop::new(lv1 as *mut _))
  }
  ...
  pub fn create_text_layout<T: HasIID>(&self, string: &[WCHAR], textFormat: &T, maxWidth: FLOAT, maxHeight: FLOAT) -> HResult<DWriteTextLayout> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFactory)).CreateTextLayout(slice_as_ptr(string),  same_length(&[Some(string.len())]).expect("Arrays must have equal sizes") as UINT32, textFormat.iptr() as *mut _ as *mut _ , maxWidth, maxHeight, &mut lv1 as *mut *mut _) };
    hr2ret(hr,DWriteTextLayout::new(lv1 as *mut _))
  }
  ...
  pub fn create_ellipsis_trimming_sign<T: HasIID>(&self, textFormat: &T) -> HResult<DWriteInlineObject> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFactory)).CreateEllipsisTrimmingSign(textFormat.iptr() as *mut _ as *mut _ , &mut lv1 as *mut *mut _) };
    hr2ret(hr,DWriteInlineObject::new(lv1 as *mut _))
  }
  ...
  pub fn create_text_analyzer(&self) -> HResult<DWriteTextAnalyzer> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFactory)).CreateTextAnalyzer(&mut lv1 as *mut *mut _) };
    hr2ret(hr,DWriteTextAnalyzer::new(lv1 as *mut _))
  }
  ...
  pub fn create_number_substitution(&self, substitutionMethod: DWRITE_NUMBER_SUBSTITUTION_METHOD, localeName: &WCHAR, ignoreUserOverride: BOOL) -> HResult<DWriteNumberSubstitution> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFactory)).CreateNumberSubstitution(substitutionMethod, localeName, ignoreUserOverride, &mut lv1 as *mut *mut _) };
    hr2ret(hr,DWriteNumberSubstitution::new(lv1 as *mut _))
  }
  ...
  pub fn create_glyph_run_analysis(&self, glyphRun: &DWRITE_GLYPH_RUN, pixelsPerDip: FLOAT, transform: &DWRITE_MATRIX, renderingMode: DWRITE_RENDERING_MODE, measuringMode: DWRITE_MEASURING_MODE, baselineOriginX: FLOAT, baselineOriginY: FLOAT) -> HResult<DWriteGlyphRunAnalysis> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFactory)).CreateGlyphRunAnalysis(glyphRun, pixelsPerDip, transform, renderingMode, measuringMode, baselineOriginX, baselineOriginY, &mut lv1 as *mut *mut _) };
    hr2ret(hr,DWriteGlyphRunAnalysis::new(lv1 as *mut _))
  }
...
impl DWriteFontCollection {
  ...
  pub fn get_font_family_count(&self) -> UINT32 {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFontCollection)).GetFontFamilyCount() };
    hr
  }
  ...
  pub fn get_font_family(&self, index: UINT32) -> HResult<DWriteFontFamily> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFontCollection)).GetFontFamily(index, &mut lv1 as *mut *mut _) };
    hr2ret(hr,DWriteFontFamily::new(lv1 as *mut _))
  }
  ...
  pub fn find_family_name(&self, familyName: &WCHAR) -> HResult<(UINT32, BOOL)> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFontCollection)).FindFamilyName(familyName, &mut lv1 as *mut _ as *mut _, &mut lv2 as *mut _ as *mut _) };
    hr2ret(hr,(lv1, lv2))
  }
  ...
  pub fn get_font_from_font_face<T: HasIID>(&self, fontFace: &T) -> HResult<DWriteFont> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFontCollection)).GetFontFromFontFace(fontFace.iptr() as *mut _ as *mut _ , &mut lv1 as *mut *mut _) };
    hr2ret(hr,DWriteFont::new(lv1 as *mut _))
  }
...
impl DWriteFontFace {
  ...
  pub fn get_type(&self) -> DWRITE_FONT_FACE_TYPE {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFontFace)).GetType() };
    hr
  }
  ...
  pub fn get_index(&self) -> UINT32 {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFontFace)).GetIndex() };
    hr
  }
  ...
  pub fn get_simulations(&self) -> DWRITE_FONT_SIMULATIONS {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFontFace)).GetSimulations() };
    hr
  }
  ...
  pub fn is_symbol_font(&self) -> BOOL {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFontFace)).IsSymbolFont() };
    hr
  }
  ...
  pub fn get_metrics(&self) -> DWRITE_FONT_METRICS {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFontFace)).GetMetrics(&mut lv1 as *mut _ as *mut _) };
    lv1
  }
  ...
  pub fn get_glyph_count(&self) -> UINT16 {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFontFace)).GetGlyphCount() };
    hr
  }
  ...
  pub fn get_design_glyph_metrics(&self, glyphIndices: &[UINT16], isSideways: BOOL) -> HResult<DWRITE_GLYPH_METRICS> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFontFace)).GetDesignGlyphMetrics(slice_as_ptr(glyphIndices),  same_length(&[Some(glyphIndices.len())]).expect("Arrays must have equal sizes") as UINT32, &mut lv1 as *mut _ as *mut _, isSideways) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn get_glyph_indices(&self, codePoints: &[UINT32], glyphIndices: &mut [UINT16]) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFontFace)).GetGlyphIndices(slice_as_ptr(codePoints),  same_length(&[Some(codePoints.len()),Some(glyphIndices.len())]).expect("Arrays must have equal sizes") as UINT32, slice_as_mut_ptr(glyphIndices)) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_recommended_rendering_mode<T: HasIID>(&self, emSize: FLOAT, pixelsPerDip: FLOAT, measuringMode: DWRITE_MEASURING_MODE, renderingParams: &T) -> HResult<DWRITE_RENDERING_MODE> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFontFace)).GetRecommendedRenderingMode(emSize, pixelsPerDip, measuringMode, renderingParams.iptr() as *mut _ as *mut _ , &mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn get_gdi_compatible_metrics(&self, emSize: FLOAT, pixelsPerDip: FLOAT, transform: Option<&DWRITE_MATRIX>) -> HResult<DWRITE_FONT_METRICS> {
    let mut lv1: DWRITE_FONT_METRICS = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut IDWriteFontFace)).GetGdiCompatibleMetrics(emSize, pixelsPerDip, transform.as_ref().map(|p|*p as *const _ as *const _).unwrap_or(ptr::null()), &mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn get_gdi_compatible_glyph_metrics(&self, emSize: FLOAT, pixelsPerDip: FLOAT, transform: Option<&DWRITE_MATRIX>, useGdiNatural: BOOL, glyphIndices: &[UINT16], glyphMetrics: &mut [DWRITE_GLYPH_METRICS], isSideways: BOOL) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFontFace)).GetGdiCompatibleGlyphMetrics(emSize, pixelsPerDip, transform.as_ref().map(|p|*p as *const _ as *const _).unwrap_or(ptr::null()), useGdiNatural, slice_as_ptr(glyphIndices),  same_length(&[Some(glyphIndices.len()),Some(glyphMetrics.len())]).expect("Arrays must have equal sizes") as UINT32, slice_as_mut_ptr(glyphMetrics), isSideways) };
    hr2ret(hr,hr)
  }
...
impl DWriteFontFamily {
  ...
  pub fn get_font_collection(&self) -> HResult<DWriteFontCollection> {
    let mut lv1: *mut IDWriteFontCollection = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut IDWriteFontList)).GetFontCollection(&mut lv1 as *mut *mut _) };
    hr2ret(hr,DWriteFontCollection::new(lv1 as *mut _))
  }
  ...
  pub fn get_font_count(&self) -> UINT32 {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFontList)).GetFontCount() };
    hr
  }
  ...
  pub fn get_font(&self, index: UINT32) -> HResult<DWriteFont> {
    let mut lv1: *mut IDWriteFont = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut IDWriteFontList)).GetFont(index, &mut lv1 as *mut *mut _) };
    hr2ret(hr,DWriteFont::new(lv1 as *mut _))
  }
  ...
  pub fn get_family_names(&self) -> HResult<DWriteLocalizedStrings> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFontFamily)).GetFamilyNames(&mut lv1 as *mut *mut _) };
    hr2ret(hr,DWriteLocalizedStrings::new(lv1 as *mut _))
  }
  ...
  pub fn get_first_matching_font(&self, weight: DWRITE_FONT_WEIGHT, stretch: DWRITE_FONT_STRETCH, style: DWRITE_FONT_STYLE) -> HResult<DWriteFont> {
    let mut lv1: *mut IDWriteFont = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut IDWriteFontFamily)).GetFirstMatchingFont(weight, stretch, style, &mut lv1 as *mut *mut _) };
    hr2ret(hr,DWriteFont::new(lv1 as *mut _))
  }
  ...
  pub fn get_matching_fonts(&self, weight: DWRITE_FONT_WEIGHT, stretch: DWRITE_FONT_STRETCH, style: DWRITE_FONT_STYLE) -> HResult<DWriteFontList> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFontFamily)).GetMatchingFonts(weight, stretch, style, &mut lv1 as *mut *mut _) };
    hr2ret(hr,DWriteFontList::new(lv1 as *mut _))
  }
...
impl DWriteFontFileEnumerator {
  ...
  pub fn move_next(&self) -> HResult<BOOL> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFontFileEnumerator)).MoveNext(&mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn get_current_font_file(&self) -> HResult<DWriteFontFile> {
    let mut lv1: *mut IDWriteFontFile = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut IDWriteFontFileEnumerator)).GetCurrentFontFile(&mut lv1 as *mut *mut _) };
    hr2ret(hr,DWriteFontFile::new(lv1 as *mut _))
  }
...
impl DWriteFont {
  ...
  pub fn get_font_family(&self) -> HResult<DWriteFontFamily> {
    let mut lv1: *mut IDWriteFontFamily = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut IDWriteFont)).GetFontFamily(&mut lv1 as *mut *mut _) };
    hr2ret(hr,DWriteFontFamily::new(lv1 as *mut _))
  }
  ...
  pub fn get_weight(&self) -> DWRITE_FONT_WEIGHT {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFont)).GetWeight() };
    hr
  }
  ...
  pub fn get_stretch(&self) -> DWRITE_FONT_STRETCH {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFont)).GetStretch() };
    hr
  }
  ...
  pub fn get_style(&self) -> DWRITE_FONT_STYLE {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFont)).GetStyle() };
    hr
  }
  ...
  pub fn is_symbol_font(&self) -> BOOL {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFont)).IsSymbolFont() };
    hr
  }
  ...
  pub fn get_face_names(&self) -> HResult<DWriteLocalizedStrings> {
    let mut lv1: *mut IDWriteLocalizedStrings = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut IDWriteFont)).GetFaceNames(&mut lv1 as *mut *mut _) };
    hr2ret(hr,DWriteLocalizedStrings::new(lv1 as *mut _))
  }
  ...
  pub fn get_informational_strings(&self, informationalStringID: DWRITE_INFORMATIONAL_STRING_ID) -> HResult<(DWriteLocalizedStrings, BOOL)> {
    let mut lv1: *mut IDWriteLocalizedStrings = ptr::null_mut();
    let mut lv2: BOOL = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut IDWriteFont)).GetInformationalStrings(informationalStringID, &mut lv1 as *mut *mut _, &mut lv2 as *mut _ as *mut _) };
    hr2ret(hr,(DWriteLocalizedStrings::new(lv1 as *mut _), lv2))
  }
  ...
  pub fn get_simulations(&self) -> DWRITE_FONT_SIMULATIONS {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFont)).GetSimulations() };
    hr
  }
  ...
  pub fn get_metrics(&self) -> DWRITE_FONT_METRICS {
    let mut lv1: DWRITE_FONT_METRICS = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut IDWriteFont)).GetMetrics(&mut lv1 as *mut _ as *mut _) };
    lv1
  }
  ...
  pub fn has_character(&self, unicodeValue: UINT32) -> HResult<BOOL> {
    let mut lv1: BOOL = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut IDWriteFont)).HasCharacter(unicodeValue, &mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn create_font_face(&self) -> HResult<DWriteFontFace> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteFont)).CreateFontFace(&mut lv1 as *mut *mut _) };
    hr2ret(hr,DWriteFontFace::new(lv1 as *mut _))
  }
...
impl DWriteGdiInterop {
  ...
  pub fn create_font_from_logfont(&self, logFont: &LOGFONTW) -> HResult<DWriteFont> {
    let mut lv1: *mut IDWriteFont = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut IDWriteGdiInterop)).CreateFontFromLOGFONT(logFont, &mut lv1 as *mut *mut _) };
    hr2ret(hr,DWriteFont::new(lv1 as *mut _))
  }
  ...
  pub fn convert_font_to_logfont<T: HasIID>(&self, font: &T) -> HResult<(LOGFONTW, BOOL)> {
    ...
    let mut lv2: BOOL = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut IDWriteGdiInterop)).ConvertFontToLOGFONT(font.iptr() as *mut _ as *mut _ , &mut lv1 as *mut _ as *mut _, &mut lv2 as *mut _ as *mut _) };
    hr2ret(hr,(lv1, lv2))
  }
  ...
  pub fn convert_font_face_to_logfont<T: HasIID>(&self, font: &T) -> HResult<LOGFONTW> {
    let mut lv1: LOGFONTW = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut IDWriteGdiInterop)).ConvertFontFaceToLOGFONT(font.iptr() as *mut _ as *mut _ , &mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn create_font_face_from_hdc(&self, hdc: HDC) -> HResult<DWriteFontFace> {
    let mut lv1: *mut IDWriteFontFace = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut IDWriteGdiInterop)).CreateFontFaceFromHdc(hdc, &mut lv1 as *mut *mut _) };
    hr2ret(hr,DWriteFontFace::new(lv1 as *mut _))
  }
  ...
  pub fn create_bitmap_render_target(&self, hdc: Option<HDC>, width: UINT32, height: UINT32) -> HResult<DWriteBitmapRenderTarget> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteGdiInterop)).CreateBitmapRenderTarget(match hdc{Some(v)=>v, _=>ptr::null_mut() as HDC}, width, height, &mut lv1 as *mut *mut _) };
    hr2ret(hr,DWriteBitmapRenderTarget::new(lv1 as *mut _))
  }
...
impl DWriteGlyphRunAnalysis {
  ...
  pub fn get_alpha_texture_bounds(&self, textureType: DWRITE_TEXTURE_TYPE) -> HResult<RECT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteGlyphRunAnalysis)).GetAlphaTextureBounds(textureType, &mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn create_alpha_texture(&self, textureType: DWRITE_TEXTURE_TYPE, textureBounds: &RECT, alphaValues: &mut [BYTE]) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteGlyphRunAnalysis)).CreateAlphaTexture(textureType, textureBounds, slice_as_mut_ptr(alphaValues),  same_length(&[Some(alphaValues.len())]).expect("Arrays must have equal sizes") as UINT32) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_alpha_blend_params<T: HasIID>(&self, renderingParams: &T) -> HResult<(FLOAT, FLOAT, FLOAT)> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteGlyphRunAnalysis)).GetAlphaBlendParams(renderingParams.iptr() as *mut _ as *mut _ , &mut lv1 as *mut _ as *mut _, &mut lv2 as *mut _ as *mut _, &mut lv3 as *mut _ as *mut _) };
    hr2ret(hr,(lv1, lv2, lv3))
  }
...
impl DWriteInlineObject {
  ...
  pub fn draw<T, T1: HasIID, T2: HasIID>(&self, clientDrawingContext: &mut [T], renderer: &T1, originX: FLOAT, originY: FLOAT, isSideways: BOOL, isRightToLeft: BOOL, clientDrawingEffect: &T2) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteInlineObject)).Draw(clientDrawingContext.as_mut_ptr() as *mut _, renderer.iptr() as *mut _ as *mut _ , originX, originY, isSideways, isRightToLeft, clientDrawingEffect.iptr() as *mut _ as *mut _ ) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_metrics(&self) -> HResult<DWRITE_INLINE_OBJECT_METRICS> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteInlineObject)).GetMetrics(&mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn get_overhang_metrics(&self) -> HResult<DWRITE_OVERHANG_METRICS> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteInlineObject)).GetOverhangMetrics(&mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn get_break_conditions(&self) -> HResult<(DWRITE_BREAK_CONDITION, DWRITE_BREAK_CONDITION)> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteInlineObject)).GetBreakConditions(&mut lv1 as *mut _ as *mut _, &mut lv2 as *mut _ as *mut _) };
    hr2ret(hr,(lv1, lv2))
  }
...
impl DWriteLocalFontFileLoader {
  ...
  pub fn get_file_path_length_from_key<T>(&self, fontFileReferenceKey: &T) -> HResult<UINT32> {
    let mut lv1: UINT32 = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut IDWriteLocalFontFileLoader)).GetFilePathLengthFromKey(fontFileReferenceKey as *const _ as *const _, mem::size_of_val(fontFileReferenceKey) as UINT32, &mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn get_file_path_from_key<T>(&self, fontFileReferenceKey: &T, filePath: &mut [WCHAR]) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteLocalFontFileLoader)).GetFilePathFromKey(fontFileReferenceKey as *const _ as *const _, mem::size_of_val(fontFileReferenceKey) as UINT32, slice_as_mut_ptr(filePath),  same_length(&[Some(filePath.len())]).expect("Arrays must have equal sizes") as UINT32) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_last_write_time_from_key<T>(&self, fontFileReferenceKey: &T) -> HResult<FILETIME> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteLocalFontFileLoader)).GetLastWriteTimeFromKey(fontFileReferenceKey as *const _ as *const _, mem::size_of_val(fontFileReferenceKey) as UINT32, &mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
...
impl DWriteLocalizedStrings {
  ...
  pub fn get_count(&self) -> UINT32 {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteLocalizedStrings)).GetCount() };
    hr
  }
  ...
  pub fn find_locale_name(&self, localeName: &WCHAR) -> HResult<(UINT32, BOOL)> {
    let mut lv1: UINT32 = unsafe {mem::uninitialized::<_>()};
    let mut lv2: BOOL = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut IDWriteLocalizedStrings)).FindLocaleName(localeName, &mut lv1 as *mut _ as *mut _, &mut lv2 as *mut _ as *mut _) };
    hr2ret(hr,(lv1, lv2))
  }
  ...
  pub fn get_locale_name_length(&self, index: UINT32) -> HResult<UINT32> {
    let mut lv1: UINT32 = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut IDWriteLocalizedStrings)).GetLocaleNameLength(index, &mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn get_locale_name(&self, index: UINT32, localeName: &mut [WCHAR]) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteLocalizedStrings)).GetLocaleName(index, slice_as_mut_ptr(localeName),  same_length(&[Some(localeName.len())]).expect("Arrays must have equal sizes") as UINT32) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_string_length(&self, index: UINT32) -> HResult<UINT32> {
    let mut lv1: UINT32 = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut IDWriteLocalizedStrings)).GetStringLength(index, &mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn get_string(&self, index: UINT32, stringBuffer: &mut [WCHAR]) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteLocalizedStrings)).GetString(index, slice_as_mut_ptr(stringBuffer),  same_length(&[Some(stringBuffer.len())]).expect("Arrays must have equal sizes") as UINT32) };
    hr2ret(hr,hr)
  }
...
impl DWritePixelSnapping {
  ...
  pub unsafe fn is_pixel_snapping_disabled<T>(&self, clientDrawingContext: &mut [T]) -> HResult<BOOL> {
    let mut lv1: BOOL = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut IDWritePixelSnapping)).IsPixelSnappingDisabled(clientDrawingContext.as_mut_ptr() as *mut _, &mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub unsafe fn get_current_transform<T>(&self, clientDrawingContext: &mut [T]) -> HResult<DWRITE_MATRIX> {
    let mut lv1: DWRITE_MATRIX = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut IDWritePixelSnapping)).GetCurrentTransform(clientDrawingContext.as_mut_ptr() as *mut _, &mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub unsafe fn get_pixels_per_dip<T>(&self, clientDrawingContext: &mut [T]) -> HResult<FLOAT> {
    let mut lv1: FLOAT = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut IDWritePixelSnapping)).GetPixelsPerDip(clientDrawingContext.as_mut_ptr() as *mut _, &mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
...
impl DWriteRenderingParams {
  ...
  pub fn get_gamma(&self) -> FLOAT {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteRenderingParams)).GetGamma() };
    hr
  }
  ...
  pub fn get_enhanced_contrast(&self) -> FLOAT {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteRenderingParams)).GetEnhancedContrast() };
    hr
  }
  ...
  pub fn get_clear_type_level(&self) -> FLOAT {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteRenderingParams)).GetClearTypeLevel() };
    hr
  }
  ...
  pub fn get_pixel_geometry(&self) -> DWRITE_PIXEL_GEOMETRY {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteRenderingParams)).GetPixelGeometry() };
    hr
  }
  ...
  pub fn get_rendering_mode(&self) -> DWRITE_RENDERING_MODE {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteRenderingParams)).GetRenderingMode() };
    hr
  }
...
impl DWriteTextAnalyzer {
  ...
  pub fn analyze_script(&self, analysisSource: &mut IDWriteTextAnalysisSource, textPosition: UINT32, textLength: UINT32, analysisSink: &mut IDWriteTextAnalysisSink) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextAnalyzer)).AnalyzeScript(analysisSource, textPosition, textLength, analysisSink) };
    hr2ret(hr,hr)
  }
  ...
  pub fn analyze_bidi(&self, analysisSource: &mut IDWriteTextAnalysisSource, textPosition: UINT32, textLength: UINT32, analysisSink: &mut IDWriteTextAnalysisSink) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextAnalyzer)).AnalyzeBidi(analysisSource, textPosition, textLength, analysisSink) };
    hr2ret(hr,hr)
  }
  ...
  pub fn analyze_number_substitution(&self, analysisSource: &mut IDWriteTextAnalysisSource, textPosition: UINT32, textLength: UINT32, analysisSink: &mut IDWriteTextAnalysisSink) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextAnalyzer)).AnalyzeNumberSubstitution(analysisSource, textPosition, textLength, analysisSink) };
    hr2ret(hr,hr)
  }
  ...
  pub fn analyze_line_breakpoints(&self, analysisSource: &mut IDWriteTextAnalysisSource, textPosition: UINT32, textLength: UINT32, analysisSink: &mut IDWriteTextAnalysisSink) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextAnalyzer)).AnalyzeLineBreakpoints(analysisSource, textPosition, textLength, analysisSink) };
    hr2ret(hr,hr)
  }
...
impl DWriteTextFormat {
  ...
  pub fn set_text_alignment(&self, textAlignment: DWRITE_TEXT_ALIGNMENT) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextFormat)).SetTextAlignment(textAlignment) };
    hr2ret(hr,hr)
  }
  ...
  pub fn set_paragraph_alignment(&self, paragraphAlignment: DWRITE_PARAGRAPH_ALIGNMENT) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextFormat)).SetParagraphAlignment(paragraphAlignment) };
    hr2ret(hr,hr)
  }
  ...
  pub fn set_word_wrapping(&self, wordWrapping: DWRITE_WORD_WRAPPING) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextFormat)).SetWordWrapping(wordWrapping) };
    hr2ret(hr,hr)
  }
  ...
  pub fn set_reading_direction(&self, readingDirection: DWRITE_READING_DIRECTION) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextFormat)).SetReadingDirection(readingDirection) };
    hr2ret(hr,hr)
  }
  ...
  pub fn set_flow_direction(&self, flowDirection: DWRITE_FLOW_DIRECTION) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextFormat)).SetFlowDirection(flowDirection) };
    hr2ret(hr,hr)
  }
  ...
  pub fn set_incremental_tab_stop(&self, incrementalTabStop: FLOAT) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextFormat)).SetIncrementalTabStop(incrementalTabStop) };
    hr2ret(hr,hr)
  }
  ...
  pub fn set_trimming<T: HasIID>(&self, trimmingOptions: &DWRITE_TRIMMING, trimmingSign: &T) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextFormat)).SetTrimming(trimmingOptions, trimmingSign.iptr() as *mut _ as *mut _ ) };
    hr2ret(hr,hr)
  }
  ...
  pub fn set_line_spacing(&self, lineSpacingMethod: DWRITE_LINE_SPACING_METHOD, lineSpacing: FLOAT, baseline: FLOAT) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextFormat)).SetLineSpacing(lineSpacingMethod, lineSpacing, baseline) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_text_alignment(&self) -> DWRITE_TEXT_ALIGNMENT {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextFormat)).GetTextAlignment() };
    hr
  }
  ...
  pub fn get_paragraph_alignment(&self) -> DWRITE_PARAGRAPH_ALIGNMENT {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextFormat)).GetParagraphAlignment() };
    hr
  }
  ...
  pub fn get_word_wrapping(&self) -> DWRITE_WORD_WRAPPING {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextFormat)).GetWordWrapping() };
    hr
  }
  ...
  pub fn get_reading_direction(&self) -> DWRITE_READING_DIRECTION {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextFormat)).GetReadingDirection() };
    hr
  }
  ...
  pub fn get_flow_direction(&self) -> DWRITE_FLOW_DIRECTION {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextFormat)).GetFlowDirection() };
    hr
  }
  ...
  pub fn get_incremental_tab_stop(&self) -> FLOAT {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextFormat)).GetIncrementalTabStop() };
    hr
  }
  ...
  pub fn get_trimming(&self, trimmingOptions: &mut DWRITE_TRIMMING) -> HResult<DWriteInlineObject> {
    let mut lv1: *mut IDWriteInlineObject = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut IDWriteTextFormat)).GetTrimming(trimmingOptions, &mut lv1 as *mut *mut _) };
    hr2ret(hr,DWriteInlineObject::new(lv1 as *mut _))
  }
  ...
  pub fn get_line_spacing(&self) -> HResult<(DWRITE_LINE_SPACING_METHOD, FLOAT, FLOAT)> {
    ...
    let mut lv2: FLOAT = unsafe {mem::uninitialized::<_>()};
    let mut lv3: FLOAT = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut IDWriteTextFormat)).GetLineSpacing(&mut lv1 as *mut _ as *mut _, &mut lv2 as *mut _ as *mut _, &mut lv3 as *mut _ as *mut _) };
    hr2ret(hr,(lv1, lv2, lv3))
  }
  ...
  pub fn get_font_collection(&self) -> HResult<DWriteFontCollection> {
    let mut lv1: *mut IDWriteFontCollection = ptr::null_mut();
    let hr=unsafe { (*(self.0 as *mut IDWriteTextFormat)).GetFontCollection(&mut lv1 as *mut *mut _) };
    hr2ret(hr,DWriteFontCollection::new(lv1 as *mut _))
  }
  ...
  pub fn get_font_family_name_length(&self) -> UINT32 {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextFormat)).GetFontFamilyNameLength() };
    hr
  }
  ...
  pub fn get_font_family_name(&self, fontFamilyName: &mut [WCHAR]) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextFormat)).GetFontFamilyName(slice_as_mut_ptr(fontFamilyName),  same_length(&[Some(fontFamilyName.len())]).expect("Arrays must have equal sizes") as UINT32) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_font_weight(&self) -> DWRITE_FONT_WEIGHT {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextFormat)).GetFontWeight() };
    hr
  }
  ...
  pub fn get_font_style(&self) -> DWRITE_FONT_STYLE {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextFormat)).GetFontStyle() };
    hr
  }
  ...
  pub fn get_font_stretch(&self) -> DWRITE_FONT_STRETCH {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextFormat)).GetFontStretch() };
    hr
  }
  ...
  pub fn get_font_size(&self) -> FLOAT {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextFormat)).GetFontSize() };
    hr
  }
  ...
  pub fn get_locale_name_length(&self) -> UINT32 {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextFormat)).GetLocaleNameLength() };
    hr
  }
  ...
  pub fn get_locale_name(&self, localeName: &mut [WCHAR]) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextFormat)).GetLocaleName(slice_as_mut_ptr(localeName),  same_length(&[Some(localeName.len())]).expect("Arrays must have equal sizes") as UINT32) };
    hr2ret(hr,hr)
  }
...
impl DWriteTextLayout {
  ...
  pub fn set_max_width(&self, maxWidth: FLOAT) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextLayout)).SetMaxWidth(maxWidth) };
    hr2ret(hr,hr)
  }
  ...
  pub fn set_max_height(&self, maxHeight: FLOAT) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextLayout)).SetMaxHeight(maxHeight) };
    hr2ret(hr,hr)
  }
  ...
  pub fn set_font_collection<T: HasIID>(&self, fontCollection: &T, textRange: DWRITE_TEXT_RANGE) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextLayout)).SetFontCollection(fontCollection.iptr() as *mut _ as *mut _ , textRange) };
    hr2ret(hr,hr)
  }
  ...
  pub fn set_font_family_name(&self, fontFamilyName: &WCHAR, textRange: DWRITE_TEXT_RANGE) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextLayout)).SetFontFamilyName(fontFamilyName, textRange) };
    hr2ret(hr,hr)
  }
  ...
  pub fn set_font_weight(&self, fontWeight: DWRITE_FONT_WEIGHT, textRange: DWRITE_TEXT_RANGE) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextLayout)).SetFontWeight(fontWeight, textRange) };
    hr2ret(hr,hr)
  }
  ...
  pub fn set_font_style(&self, fontStyle: DWRITE_FONT_STYLE, textRange: DWRITE_TEXT_RANGE) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextLayout)).SetFontStyle(fontStyle, textRange) };
    hr2ret(hr,hr)
  }
  ...
  pub fn set_font_stretch(&self, fontStretch: DWRITE_FONT_STRETCH, textRange: DWRITE_TEXT_RANGE) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextLayout)).SetFontStretch(fontStretch, textRange) };
    hr2ret(hr,hr)
  }
  ...
  pub fn set_font_size(&self, fontSize: FLOAT, textRange: DWRITE_TEXT_RANGE) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextLayout)).SetFontSize(fontSize, textRange) };
    hr2ret(hr,hr)
  }
  ...
  pub fn set_underline(&self, hasUnderline: BOOL, textRange: DWRITE_TEXT_RANGE) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextLayout)).SetUnderline(hasUnderline, textRange) };
    hr2ret(hr,hr)
  }
  ...
  pub fn set_strikethrough(&self, hasStrikethrough: BOOL, textRange: DWRITE_TEXT_RANGE) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextLayout)).SetStrikethrough(hasStrikethrough, textRange) };
    hr2ret(hr,hr)
  }
  ...
  pub fn set_drawing_effect<T: HasIID>(&self, drawingEffect: &T, textRange: DWRITE_TEXT_RANGE) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextLayout)).SetDrawingEffect(drawingEffect.iptr() as *mut _ as *mut _ , textRange) };
    hr2ret(hr,hr)
  }
  ...
  pub fn set_inline_object<T: HasIID>(&self, inlineObject: &T, textRange: DWRITE_TEXT_RANGE) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextLayout)).SetInlineObject(inlineObject.iptr() as *mut _ as *mut _ , textRange) };
    hr2ret(hr,hr)
  }
  ...
  pub fn set_typography<T: HasIID>(&self, typography: &T, textRange: DWRITE_TEXT_RANGE) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextLayout)).SetTypography(typography.iptr() as *mut _ as *mut _ , textRange) };
    hr2ret(hr,hr)
  }
  ...
  pub fn set_locale_name(&self, localeName: &WCHAR, textRange: DWRITE_TEXT_RANGE) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextLayout)).SetLocaleName(localeName, textRange) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_max_width(&self) -> FLOAT {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextLayout)).GetMaxWidth() };
    hr
  }
  ...
  pub fn get_max_height(&self) -> FLOAT {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextLayout)).GetMaxHeight() };
    hr
  }
  ...
  pub fn get_font_collection_tl(&self, currentPosition: UINT32) -> HResult<(DWriteFontCollection, DWRITE_TEXT_RANGE)> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextLayout)).GetFontCollection(currentPosition, &mut lv1 as *mut *mut _, &mut lv2 as *mut _ as *mut _) };
    hr2ret(hr,(DWriteFontCollection::new(lv1 as *mut _), lv2))
  }
  ...
  pub fn get_font_family_name_length_tl(&self, currentPosition: UINT32) -> HResult<(UINT32, DWRITE_TEXT_RANGE)> {
    let mut lv1: UINT32 = unsafe {mem::uninitialized::<_>()};
    let mut lv2: DWRITE_TEXT_RANGE = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut IDWriteTextLayout)).GetFontFamilyNameLength(currentPosition, &mut lv1 as *mut _ as *mut _, &mut lv2 as *mut _ as *mut _) };
    hr2ret(hr,(lv1, lv2))
  }
  ...
  pub fn get_font_family_name_tl(&self, currentPosition: UINT32, fontFamilyName: &mut [WCHAR]) -> HResult<DWRITE_TEXT_RANGE> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextLayout)).GetFontFamilyName(currentPosition, slice_as_mut_ptr(fontFamilyName),  same_length(&[Some(fontFamilyName.len())]).expect("Arrays must have equal sizes") as UINT32, &mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn get_font_weight_tl(&self, currentPosition: UINT32) -> HResult<(DWRITE_FONT_WEIGHT, DWRITE_TEXT_RANGE)> {
    ...
    let mut lv2: DWRITE_TEXT_RANGE = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut IDWriteTextLayout)).GetFontWeight(currentPosition, &mut lv1 as *mut _ as *mut _, &mut lv2 as *mut _ as *mut _) };
    hr2ret(hr,(lv1, lv2))
  }
  ...
  pub fn get_font_style_tl(&self, currentPosition: UINT32) -> HResult<(DWRITE_FONT_STYLE, DWRITE_TEXT_RANGE)> {
    ...
    let mut lv2: DWRITE_TEXT_RANGE = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut IDWriteTextLayout)).GetFontStyle(currentPosition, &mut lv1 as *mut _ as *mut _, &mut lv2 as *mut _ as *mut _) };
    hr2ret(hr,(lv1, lv2))
  }
  ...
  pub fn get_font_stretch_tl(&self, currentPosition: UINT32) -> HResult<(DWRITE_FONT_STRETCH, DWRITE_TEXT_RANGE)> {
    ...
    let mut lv2: DWRITE_TEXT_RANGE = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut IDWriteTextLayout)).GetFontStretch(currentPosition, &mut lv1 as *mut _ as *mut _, &mut lv2 as *mut _ as *mut _) };
    hr2ret(hr,(lv1, lv2))
  }
  ...
  pub fn get_font_size_tl(&self, currentPosition: UINT32) -> HResult<(FLOAT, DWRITE_TEXT_RANGE)> {
    let mut lv1: FLOAT = unsafe {mem::uninitialized::<_>()};
    let mut lv2: DWRITE_TEXT_RANGE = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut IDWriteTextLayout)).GetFontSize(currentPosition, &mut lv1 as *mut _ as *mut _, &mut lv2 as *mut _ as *mut _) };
    hr2ret(hr,(lv1, lv2))
  }
  ...
  pub fn get_underline(&self, currentPosition: UINT32, hasUnderline: &mut BOOL, textRange: &mut DWRITE_TEXT_RANGE) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextLayout)).GetUnderline(currentPosition, hasUnderline, textRange) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_strikethrough(&self, currentPosition: UINT32) -> HResult<(BOOL, DWRITE_TEXT_RANGE)> {
    let mut lv1: BOOL = unsafe {mem::uninitialized::<_>()};
    let mut lv2: DWRITE_TEXT_RANGE = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut IDWriteTextLayout)).GetStrikethrough(currentPosition, &mut lv1 as *mut _ as *mut _, &mut lv2 as *mut _ as *mut _) };
    hr2ret(hr,(lv1, lv2))
  }
  ...
  pub fn get_drawing_effect(&self, currentPosition: UINT32) -> HResult<(Unknown, DWRITE_TEXT_RANGE)> {
    ...
    let mut lv2: DWRITE_TEXT_RANGE = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut IDWriteTextLayout)).GetDrawingEffect(currentPosition, &mut lv1 as *mut *mut _, &mut lv2 as *mut _ as *mut _) };
    hr2ret(hr,(Unknown::new(lv1 as *mut _), lv2))
  }
  ...
  pub fn get_inline_object(&self, currentPosition: UINT32) -> HResult<(DWriteInlineObject, DWRITE_TEXT_RANGE)> {
    let mut lv1: *mut IDWriteInlineObject = ptr::null_mut();
    let mut lv2: DWRITE_TEXT_RANGE = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut IDWriteTextLayout)).GetInlineObject(currentPosition, &mut lv1 as *mut *mut _, &mut lv2 as *mut _ as *mut _) };
    hr2ret(hr,(DWriteInlineObject::new(lv1 as *mut _), lv2))
  }
  ...
  pub fn get_typography(&self, currentPosition: UINT32) -> HResult<(DWriteTypography, DWRITE_TEXT_RANGE)> {
    let mut lv1: *mut IDWriteTypography = ptr::null_mut();
    let mut lv2: DWRITE_TEXT_RANGE = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut IDWriteTextLayout)).GetTypography(currentPosition, &mut lv1 as *mut *mut _, &mut lv2 as *mut _ as *mut _) };
    hr2ret(hr,(DWriteTypography::new(lv1 as *mut _), lv2))
  }
  ...
  pub fn get_locale_name_length_tl(&self, currentPosition: UINT32) -> HResult<(UINT32, DWRITE_TEXT_RANGE)> {
    let mut lv1: UINT32 = unsafe {mem::uninitialized::<_>()};
    let mut lv2: DWRITE_TEXT_RANGE = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut IDWriteTextLayout)).GetLocaleNameLength(currentPosition, &mut lv1 as *mut _ as *mut _, &mut lv2 as *mut _ as *mut _) };
    hr2ret(hr,(lv1, lv2))
  }
  ...
  pub fn get_locale_name_tl(&self, currentPosition: UINT32, localeName: &mut [WCHAR]) -> HResult<DWRITE_TEXT_RANGE> {
    let mut lv1: DWRITE_TEXT_RANGE = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut IDWriteTextLayout)).GetLocaleName(currentPosition, slice_as_mut_ptr(localeName),  same_length(&[Some(localeName.len())]).expect("Arrays must have equal sizes") as UINT32, &mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub unsafe fn draw<T, T1: HasIID>(&self, clientDrawingContext: &mut [T], renderer: &T1, originX: FLOAT, originY: FLOAT) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextLayout)).Draw(clientDrawingContext.as_mut_ptr() as *mut _, renderer.iptr() as *mut _ as *mut _ , originX, originY) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_line_metrics(&self, lineMetrics: Option<&mut [DWRITE_LINE_METRICS]>) -> HResult<UINT32> {
    let mut lv1: UINT32 = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut IDWriteTextLayout)).GetLineMetrics(opt_arr_as_mut_ptr(&lineMetrics) as *mut _,  same_length(&[lineMetrics.as_ref().map(|a|a.len())]).expect("Arrays must have equal sizes") as UINT32, &mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn get_metrics(&self) -> HResult<DWRITE_TEXT_METRICS> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextLayout)).GetMetrics(&mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn get_overhang_metrics(&self) -> HResult<DWRITE_OVERHANG_METRICS> {
    let mut lv1: DWRITE_OVERHANG_METRICS = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut IDWriteTextLayout)).GetOverhangMetrics(&mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn get_cluster_metrics(&self, clusterMetrics: Option<&mut [DWRITE_CLUSTER_METRICS]>) -> HResult<UINT32> {
    let mut lv1: UINT32 = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut IDWriteTextLayout)).GetClusterMetrics(opt_arr_as_mut_ptr(&clusterMetrics) as *mut _,  same_length(&[clusterMetrics.as_ref().map(|a|a.len())]).expect("Arrays must have equal sizes") as UINT32, &mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn determine_min_width(&self) -> HResult<FLOAT> {
    let mut lv1: FLOAT = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut IDWriteTextLayout)).DetermineMinWidth(&mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
  ...
  pub fn hit_test_point(&self, pointX: FLOAT, pointY: FLOAT) -> HResult<(BOOL, BOOL, DWRITE_HIT_TEST_METRICS)> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextLayout)).HitTestPoint(pointX, pointY, &mut lv1 as *mut _ as *mut _, &mut lv2 as *mut _ as *mut _, &mut lv3 as *mut _ as *mut _) };
    hr2ret(hr,(lv1, lv2, lv3))
  }
  ...
  pub fn hit_test_text_position(&self, textPosition: UINT32, isTrailingHit: BOOL) -> HResult<(FLOAT, FLOAT, DWRITE_HIT_TEST_METRICS)> {
    ...
    let mut lv2: FLOAT = unsafe {mem::uninitialized::<_>()};
    let mut lv3: DWRITE_HIT_TEST_METRICS = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut IDWriteTextLayout)).HitTestTextPosition(textPosition, isTrailingHit, &mut lv1 as *mut _ as *mut _, &mut lv2 as *mut _ as *mut _, &mut lv3 as *mut _ as *mut _) };
    hr2ret(hr,(lv1, lv2, lv3))
  }
  ...
  pub fn hit_test_text_range(&self, textPosition: UINT32, textLength: UINT32, originX: FLOAT, originY: FLOAT, hitTestMetrics: Option<&mut [DWRITE_HIT_TEST_METRICS]>) -> HResult<UINT32> {
    let mut lv1: UINT32 = unsafe {mem::uninitialized::<_>()};
    let hr=unsafe { (*(self.0 as *mut IDWriteTextLayout)).HitTestTextRange(textPosition, textLength, originX, originY, opt_arr_as_mut_ptr(&hitTestMetrics) as *mut _,  same_length(&[hitTestMetrics.as_ref().map(|a|a.len())]).expect("Arrays must have equal sizes") as UINT32, &mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
...
impl DWriteTextRenderer {
  ...
  pub unsafe fn draw_glyph_run<T, T1: HasIID>(&self, clientDrawingContext: &mut [T], baselineOriginX: FLOAT, baselineOriginY: FLOAT, measuringMode: DWRITE_MEASURING_MODE, glyphRun: &DWRITE_GLYPH_RUN, glyphRunDescription: &DWRITE_GLYPH_RUN_DESCRIPTION, clientDrawingEffect: &T1) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextRenderer)).DrawGlyphRun(clientDrawingContext.as_mut_ptr() as *mut _, baselineOriginX, baselineOriginY, measuringMode, glyphRun, glyphRunDescription, clientDrawingEffect.iptr() as *mut _ as *mut _ ) };
    hr2ret(hr,hr)
  }
  ...
  pub unsafe fn draw_underline<T, T1: HasIID>(&self, clientDrawingContext: &mut [T], baselineOriginX: FLOAT, baselineOriginY: FLOAT, underline: &DWRITE_UNDERLINE, clientDrawingEffect: &T1) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextRenderer)).DrawUnderline(clientDrawingContext.as_mut_ptr() as *mut _, baselineOriginX, baselineOriginY, underline, clientDrawingEffect.iptr() as *mut _ as *mut _ ) };
    hr2ret(hr,hr)
  }
  ...
  pub unsafe fn draw_strikethrough<T, T1: HasIID>(&self, clientDrawingContext: &mut [T], baselineOriginX: FLOAT, baselineOriginY: FLOAT, strikethrough: &DWRITE_STRIKETHROUGH, clientDrawingEffect: &T1) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextRenderer)).DrawStrikethrough(clientDrawingContext.as_mut_ptr() as *mut _, baselineOriginX, baselineOriginY, strikethrough, clientDrawingEffect.iptr() as *mut _ as *mut _ ) };
    hr2ret(hr,hr)
  }
  ...
  pub unsafe fn draw_inline_object<T, T1: HasIID, T2: HasIID>(&self, clientDrawingContext: &mut [T], originX: FLOAT, originY: FLOAT, inlineObject: &T1, isSideways: BOOL, isRightToLeft: BOOL, clientDrawingEffect: &T2) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTextRenderer)).DrawInlineObject(clientDrawingContext.as_mut_ptr() as *mut _, originX, originY, inlineObject.iptr() as *mut _ as *mut _ , isSideways, isRightToLeft, clientDrawingEffect.iptr() as *mut _ as *mut _ ) };
    hr2ret(hr,hr)
  }
...
impl DWriteTypography {
  ...
  pub fn add_font_feature(&self, fontFeature: DWRITE_FONT_FEATURE) -> HResult<HRESULT> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTypography)).AddFontFeature(fontFeature) };
    hr2ret(hr,hr)
  }
  ...
  pub fn get_font_feature_count(&self) -> UINT32 {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTypography)).GetFontFeatureCount() };
    hr
  }
  ...
  pub fn get_font_feature(&self, fontFeatureIndex: UINT32) -> HResult<DWRITE_FONT_FEATURE> {
    ...
    let hr=unsafe { (*(self.0 as *mut IDWriteTypography)).GetFontFeature(fontFeatureIndex, &mut lv1 as *mut _ as *mut _) };
    hr2ret(hr,lv1)
  }
