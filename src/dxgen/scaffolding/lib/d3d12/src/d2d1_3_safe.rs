...
impl HasIID for D2D1Device2 {
  ...
  fn new(pp_vtbl : *mut IUnknown) -> Self { D2D1Device2(pp_vtbl as *mut _ as *mut ID2D1Device2) }
...
impl D2D1Device2 {
  ...
  #[allow(non_snake_case)]
  pub fn create_device_context2(&self, options: D2D1_DEVICE_CONTEXT_OPTIONS) -> HResult<D2D1DeviceContext2> {
    let mut lv1: *mut ID2D1DeviceContext2 = ptr::null_mut();
    let _hr=unsafe { (*(self.0 as *mut ID2D1Device2)).CreateDeviceContext(options, &mut lv1 as *mut *mut _) };
  ...
  #[allow(non_snake_case)]
  pub fn flush_device_contexts(&self, bitmap: &mut ID2D1Bitmap) -> () {
  
    let _hr=unsafe { (*(self.0 as *mut ID2D1Device2)).FlushDeviceContexts(bitmap) };
    ()
  }
...
impl HasIID for D2D1DeviceContext2 {
  ...
  fn new(pp_vtbl : *mut IUnknown) -> Self { D2D1DeviceContext2(pp_vtbl as *mut _ as *mut ID2D1DeviceContext2) }
  fn iptr(&self) -> *mut IUnknown { self.0 as *mut _ as  *mut IUnknown}
}
...
impl D2D1DeviceContext2 {
  ...
  //  Method CreateImageSourceFromWic
  ...
  #[allow(non_snake_case)]
  pub fn get_gradient_mesh_world_bounds(&self, gradientMesh: &mut ID2D1GradientMesh, bounds: &mut D2D1_RECT_F) -> HResult<HRESULT> {
  
    let _hr=unsafe { (*(self.0 as *mut ID2D1DeviceContext2)).GetGradientMeshWorldBounds(gradientMesh, bounds) };
    hr2ret(_hr,_hr)
  }
  ...
  #[allow(non_snake_case)]
  pub fn draw_ink(&self, ink: &mut ID2D1Ink, brush: &mut ID2D1Brush, inkStyle: &mut ID2D1InkStyle) -> () {
  
    let _hr=unsafe { (*(self.0 as *mut ID2D1DeviceContext2)).DrawInk(ink, brush, inkStyle) };
    ()
  }
  ...
  #[allow(non_snake_case)]
  pub fn draw_gradient_mesh(&self, gradientMesh: &mut ID2D1GradientMesh) -> () {
  
    let _hr=unsafe { (*(self.0 as *mut ID2D1DeviceContext2)).DrawGradientMesh(gradientMesh) };
    ()
  }
  ...
  #[allow(non_snake_case)]
  pub fn draw_gdi_metafile2(&self, gdiMetafile: &mut ID2D1GdiMetafile, destinationRectangle: &D2D1_RECT_F, sourceRectangle: &D2D1_RECT_F) -> () {
  
    let _hr=unsafe { (*(self.0 as *mut ID2D1DeviceContext2)).DrawGdiMetafile(gdiMetafile, destinationRectangle, sourceRectangle) };
    ()
  }
...
impl HasIID for D2D1Factory3 {
  ...
  fn new(pp_vtbl : *mut IUnknown) -> Self { D2D1Factory3(pp_vtbl as *mut _ as *mut ID2D1Factory3) }
  fn iptr(&self) -> *mut IUnknown { self.0 as *mut _ as  *mut IUnknown}
}
...
impl D2D1Factory3 {
  ...
  #[allow(non_snake_case)]
  pub fn create_device3<T: HasIID>(&self, dxgiDevice: &T) -> HResult<D2D1Device2> {
    let mut lv1: *mut ID2D1Device2 = ptr::null_mut();
    let _hr=unsafe { (*(self.0 as *mut ID2D1Factory3)).CreateDevice(dxgiDevice.iptr() as *mut _ as *mut _ , &mut lv1 as *mut *mut _) };
