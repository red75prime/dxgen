...
fn on_render(data: &mut AppData, x: i32, y: i32) {
  ...
  let vtc=vec![
    Vertex {pos: [(0.5*s+0.0*c)*aspect, (0.5*(-c)+0.0*s), 0.0, 0.0],color: [1.0,0.0,0.0,1.0],},
    Vertex {pos: [(-0.5*s-0.5*c)*aspect, (-0.5*(-c)-0.5*s), 0.0, 0.0],color: [0.0,0.0,1.0,1.0],},
    Vertex {pos: [(-0.5*s+0.5*c)*aspect, (-0.5*(-c)+0.5*s), 0.0, 0.0],color: [0.0,1.0,0.0,1.0],},
    Vertex {pos: [(-1.0*s+0.0*c)*aspect, (-1.0*(-c)+0.0*s), 0.0, 0.0],color: [0.0,0.5,0.5,1.0],},
  ];
...
//  debug!("Swap chain: get_maximum_frame_latency");
  ...
  let vtc=vec![
    Vertex {pos: [0.0, 0.5, 0.0, 0.0],color: [1.0,0.0,0.0,1.0],},
    Vertex {pos: [0.5, -0.5, 0.0, 0.0],color: [0.0,1.0,0.0,1.0],},
    Vertex {pos: [-0.5, -0.5, 0.0, 0.0],color: [0.0,0.0,1.0,1.0],},
    Vertex {pos: [0.0, -1.5, 0.0, 0.0],color: [0.0,0.0,1.0,1.0],},
  ];
